(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['app'],
  {
    ...
    '0bb4': function (t, a, e) {
      ...
      function n(t) {
        return Object(c['a'])({ url: i.findall, method: 'get', params: t });
      }
      function o(t) {
        return Object(c['a'])({
      ...
      function l(t) {
        return Object(c['a'])({ url: ''.concat(i.delete, '/').concat(t.uuid), method: 'delete' });
      }
    },
    '14ec': function (t, a, e) {
      'use strict';
    ...
    '331a': function (t, a) {
      var e = { admin: { token: 'admin-token' }, editor: { token: 'editor-token' } },
        c = {
          'admin-token': {
            roles: ['admin'],
      ...
      t.exports = [
        {
          ...
          response: function (t) {
            var a = t.body.username,
              c = e[a];
            return c ? { code: 200, data: c } : { code: 60204, message: 'Account and password are incorrect.' };
          },
        },
        {
          ...
          response: function (t) {
            var a = t.query.token,
              e = c[a];
            return e ? { code: 200, data: e } : { code: 50008, message: 'Login failed, unable to get user details.' };
          },
        },
        {
      ...
      var c = e('2b0e'),
        ...
        u = {
          ...
          CLOSE_SIDEBAR: function (t, a) {
            s.a.set('sidebarStatus', 0), (t.sidebar.opened = !1), (t.sidebar.withoutAnimation = a);
          },
        ...
        d = { namespaced: !0, state: r, mutations: u, actions: h },
        f = e('83d6'),
        m = e.n(f),
        p = m.a.showSettings,
        C = m.a.fixedHeader,
        g = m.a.sidebarLogo,
        D = { showSettings: p, fixedHeader: C, sidebarLogo: g },
        _ = {
        ...
        v = { namespaced: !0, state: D, mutations: _, actions: b },
        z = (e('d3b7'), e('498a'), e('c24f')),
        y = e('5f87'),
        j = e('a18c'),
        T = function () {
          return { token: Object(y['a'])(), name: '', avatar: '', role: 'user' };
        },
        J = T(),
        x = {
        ...
        A = {
          login: function (t, a) {
            ...
            return new Promise(function (t, a) {
              Object(z['e'])({ account: c.trim(), password: i })
                .then(function (a) {
                  var c = a.data;
                  e('SET_TOKEN', c.token),
                    e('SET_ROLE', c.role),
          ...
          getInfo: function (t) {
            ...
            return new Promise(function (t, c) {
              Object(z['c'])(e.token)
                .then(function (e) {
                  var i = e.data;
                  if (!i) return c('Verification failed, please Login again.');
                  var n = i.name,
                    o = i.avatar,
                    l = i.role,
                    s = i.viptime;
                  a('SET_NAME', n), a('SET_AVATAR', o), a('SET_VIPTIME', s), a('SET_ROLE', l), t(i);
                })
                .catch(function (t) {
                  c(t);
                });
          ...
          logout: function (t) {
            ...
            return new Promise(function (t, c) {
              Object(z['f'])(e.token)
                .then(function () {
                  Object(y['b'])(), Object(j['b'])(), a('RESET_STATE'), t();
                })
                .catch(function (t) {
                  c(t);
                });
          ...
          resetToken: function (t) {
            ...
            return new Promise(function (t) {
              Object(y['b'])(), a('RESET_STATE'), t();
            });
          },
        },
        w = { namespaced: !0, state: J, mutations: x, actions: A };
      c['default'].use(i['a']);
      var B = new i['a'].Store({ modules: { app: d, settings: v, user: w }, getters: o });
      a['a'] = B;
    },
    '47f1': function (t, a, e) {
      'use strict';
    ...
    '4b0f': function (t, a, e) {
      var c = e('63748').default,
        i = e('448a').default;
      e('99af'), e('b64b'), e('4d63'), e('c607'), e('ac1f'), e('2c3e'), e('25f0');
      var n = e('96eb'),
        o = e('8a60'),
        l = o.param2Obj,
        s = e('331a'),
          ...
          return function (a) {
            ...
            if (t instanceof Function) {
              var c = a.body,
                i = a.type,
                o = a.url;
              e = t({ method: i, body: JSON.parse(c), query: l(o) });
            } else e = t;
            return n.mock(e);
          };
        }
    ...
    '56d7': function (t, a, e) {
      ...
      var c = e('2b0e'),
        ...
        r = [],
        u = (e('99af'), e('ac1f'), e('466d'), window.innerWidth / 1920),
        h =
          (window.innerWidth,
          {
            name: 'App',
            metaInfo: {
              ...
              meta: [
                {
                  name: 'viewport',
                  content: 'width=device-width, user-scalable=yes, initial-scale='
                    .concat(u, ', maximum-scale=', 10, ', minimum-scale=')
                    .concat(u),
                },
              ],
            },
        ...
        b =
          ...
          function () {
            var t = this,
              ...
              e = t._self._c || a;
            return t.isExternal
              ? e('div', t._g({ staticClass: 'svg-external-icon svg-icon', style: t.styleExternalIcon }, t.$listeners))
              : e('svg', t._g({ class: t.svgClass, attrs: { 'aria-hidden': 'true' } }, t.$listeners), [
        ...
        j = y,
        T = (e('c295'), Object(f['a'])(j, b, v, !1, null, '48f35816', null)),
        J = T.exports;
      ...
      g['a'].beforeEach(
        (function () {
          var t = Object(B['a'])(
            Object(w['a'])().mark(function t(a, e, c) {
              var n, o;
              return Object(w['a'])().wrap(
                function (t) {
                  while (1)
                    switch ((t.prev = t.next)) {
                      case 0:
                        if ((S.a.start(), (document.title = q(a.meta.title)), (n = Object(O['a'])()), !n)) {
                          t.next = 29;
                          break;
                        }
                        if ('/login' !== a.path) {
                        ...
                        c({ path: '/' }), S.a.done(), (t.next = 27);
                        break;
                      case 9:
                        if (((o = C['a'].getters.name), !o)) {
                          t.next = 14;
                          break;
                        }
                        c(), (t.next = 27);
                        break;
                      case 14:
                        return (t.prev = 14), (t.next = 17), C['a'].dispatch('user/getInfo');
                      case 17:
                        c(), (t.next = 27);
                        break;
                      case 20:
                        return (
                          (t.prev = 20), (t.t0 = t['catch'](14)), (t.next = 24), C['a'].dispatch('user/resetToken')
                        );
                      case 24:
                        i['Message'].error(t.t0 || 'Has Error'), c('/login?redirect='.concat(a.path)), S.a.done();
                      case 27:
                        t.next = 30;
                        break;
                      case 29:
                        -1 !== L.indexOf(a.path) ? c() : (c('/login?redirect='.concat(a.path)), S.a.done());
                      case 30:
                      case 'end':
                        return t.stop();
                    }
        ...
        bind: function (t, a, e, c) {
          ...
          i.onmousedown = function (t) {
            var a = t.clientX - i.offsetLeft,
              ...
              p = o(n, 'top');
            m.includes('%')
              ? ((m = +document.body.clientWidth * (+m.replace(/\%/g, '') / 100)),
                (p = +document.body.clientHeight * (+p.replace(/\%/g, '') / 100)))
              : ((m = +m.replace(/\px/g, '')), (p = +p.replace(/\px/g, ''))),
      ...
      var M,
        ...
        R,
        N = e('521e'),
        V = { maxbsktProfit: M, maxftChuanProfit: P, maxftSinProfit: I, maxfttgProfit: R };
    ...
    '60a8': function (t, a, e) {
      ...
      function n(t) {
        return Object(c['a'])({ url: i.getOddsHistory, method: 'get', params: t });
      }
      function o(t) {
        return Object(c['a'])({ url: i.getBaskgetOddsHistory, method: 'get', params: t });
      }
    },
    '61f7': function (t, a, e) {
      'use strict';
    ...
    '83d6': function (t, a) {
      t.exports = { title: 'Vue Admin Template', fixedHeader: !1, sidebarLogo: !0 };
    },
    '8a60': function (t, a, e) {
      function c(t) {
      ...
      e('ac1f'), e('5319'), e('d3b7'), e('159b'), (t.exports = { param2Obj: c });
    },
    '907f': function (t, a, e) {},
    '93cd': function (t, a, e) {
      'use strict';
      ...
      t.exports = [
        {
          ...
          response: function (t) {
            var a = i.items;
            return { code: 200, data: { total: a.length, items: a } };
          },
        },
      ];
    },
    a18c: function (t, a, e) {
      ...
      var c,
        ...
        l = function () {
          ...
          return c(
            'div',
            { staticClass: 'app-wrapper demandFormVisible_dialog', class: t.classObj },
            [
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy1', src: e('4b63') } }),
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy2', src: e('7c4f') } }),
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy3', src: e('7d51') } }),
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy4', src: e('7666') } }),
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy5', src: e('9eaf') } }),
              c('audio', { staticStyle: { visibility: 'hidden' }, attrs: { id: 'tsy6', src: e('d3a5') } }),
              'mobile' === t.device && t.sidebar.opened
                ? c('div', { staticClass: 'drawer-bg', on: { click: t.handleClickOutside } })
                : t._e(),
              c('sidebar', { staticClass: 'sidebar-container' }),
              c(
                'div',
                { staticClass: 'main-container' },
                [
                  c('div', { class: { 'fixed-header': t.fixedHeader } }, [c('navbar')], 1),
                  c(
                    'el-card',
                    {
                      directives: [
                    ...
                    [
                      c(
                        ...
                        [
                          c(
                            'el-col',
                            { staticStyle: { 'line-height': '50px' }, attrs: { span: 24 } },
                            [
                              t._v(' jc单返点 : '),
                              c('el-input-number', {
                                staticStyle: { 'margin-right': '20px' },
                                attrs: { 'controls-position': 'right', precision: 3, step: 0.01, size: 'mini' },
                                on: {
                                  change: function (a) {
                              ...
                              t._v(' jc投注 : '),
                              c('el-input', {
                                staticStyle: { 'margin-right': '20px', width: '80px' },
                                attrs: { size: 'mini' },
                                on: {
                                  change: function (a) {
                              ...
                              c('el-input-number', {
                                staticStyle: { 'margin-right': '20px', width: '100px' },
                                attrs: { 'controls-position': 'right', precision: 3, step: 0.001, size: 'mini' },
                                on: {
                                  change: function (a) {
                                    return t.changeConfig();
                                  },
                              ...
                              c(
                                ...
                                [
                                  c('el-radio-button', { attrs: { label: 'all' } }, [t._v(' 全部 ')]),
                                  c('el-radio-button', { attrs: { label: 'today' } }, [t._v(' 今天 ')]),
                                  c('el-radio-button', { attrs: { label: 'tom' } }, [t._v(' 明天 ')]),
                                ],
                                1
                              ),
                              t._v(' 自动刷新 : '),
                  ...
                  t.arrNotices && t.arrNotices.length > 0
                    ? c('el-alert', { attrs: { title: t.arrNotices[0].text, type: 'success' } })
                    : t._e(),
                  t.ifConfigGeted
                    ? c('app-main', {
                        attrs: {
              ...
              c(
                ...
                [
                  c('table', { staticClass: 'vediotable' }, [
                    c('tr', [
                      c('td', { attrs: { colspan: '1' } }, [t._v('玩法')]),
                      c('td', { attrs: { colspan: '1' } }, [t._v('开关')]),
                      c('td', { attrs: { colspan: '2' } }, [t._v('音效')]),
                    ]),
                    c('tr', [
                      c('td', { attrs: { colspan: '1' } }, [t._v('单关')]),
                      c(
                        'td',
                        { attrs: { colspan: '1' } },
                        [
                          c('el-switch', {
                            staticStyle: { 'margin-right': '20px' },
                            attrs: { 'active-color': '#13ce66', 'inactive-color': '#ff4949', size: 'mini' },
                            model: {
                          ...
                          c(
                            ...
                            [
                              c(
                                'el-button',
                                {
                                  attrs: { id: 'play-pause', type: 'info', size: 'mini' },
                                  on: {
                                    click: function (a) {
                    ...
                    c('tr', [
                      c('td', { attrs: { colspan: '1' } }, [t._v('总进球数')]),
                      c(
                        'td',
                        { attrs: { colspan: '1' } },
                        [
              ...
              c(
                ...
                [
                  c('table', { staticClass: 'dangtable' }, [
                    c('tr', [
                      c('td', { attrs: { colspan: '4' } }, [
                        t._v(
                          ' [' +
                            t._s(t.matchInfo.matchNumStr) +
                            '] ' +
                            t._s(t.matchInfo.matchTimeFormat) +
                            ' 【' +
                            t._s(t.matchInfo.leagueAbbName) +
                            '】'
                        ),
                        c('span', { staticStyle: { color: 'blue' } }, [t._v(t._s(t.matchInfo.homeTeamAbbName))]),
                        t._v(' VS '),
                        c('span', { staticStyle: { color: 'red' } }, [t._v(t._s(t.matchInfo.awayTeamAbbName))]),
                      ]),
                      c(
                        'td',
                        { attrs: { colspan: '1' } },
                        [
                          c(
                            ...
                            t._l(t.arrdgtztype, function (t) {
                              return c('el-option', { key: t.value, attrs: { label: t.name, value: t.value } });
                            }),
                            1
                          ),
                        ],
                      ...
                      c(
                        ...
                        [
                          ...
                          c('el-input-number', {
                            ...
                            attrs: { 'controls-position': 'right', precision: 3, step: 0.01, size: 'small' },
                            on: {
                              change: function (a) {
                    ...
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('赔率')]),
                      c(
                        'td',
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.caluteData.JCTouz1, t.caluteData.JCgoalLine1))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '120px' },
                            attrs: { size: 'small', step: 0.01 },
                            on: {
                              change: function (a) {
                                return t.computeData();
                              },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.caluteData.JCTouz2, t.caluteData.JCgoalLine2))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '120px' },
                            attrs: {
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getText(t.caluteData.HGTouz1, t.caluteData.HGgoalLine1))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '120px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getText(t.caluteData.HGTouz2, t.caluteData.HGgoalLine2))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '120px' },
                            attrs: {
                    ...
                    c('tr', { staticStyle: { color: 'red', background: '#ecf5ff' } }, [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('下注')]),
                      c(
                        'td',
                        [
                          c('el-input', {
                      ...
                      c('td', [c('span', [t._v(t._s(parseFloat(t.caluteData.jcBet2).toFixed(0)))])]),
                      c('td', [c('span', [t._v(t._s(parseFloat(t.caluteData.hgBet1).toFixed(0)))])]),
                      c('td', [c('span', [t._v(t._s(parseFloat(t.caluteData.hgBet2).toFixed(0)))])]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('返点')]),
                      c('td', [t._v(' ' + t._s(parseFloat(t.caluteData.JCPoint1).toFixed(0)) + ' ')]),
                      c('td', [t._v(' ' + t._s(parseFloat(t.caluteData.JCPoint2).toFixed(0)) + ' ')]),
                      c('td', [t._v(' ' + t._s(parseFloat(t.caluteData.HGPoint1).toFixed(0)) + ' ')]),
                      c('td', [t._v(' ' + t._s(parseFloat(t.caluteData.HGPoint2).toFixed(0)) + ' ')]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('中奖金额')]),
                      c('td', [t._v(t._s(parseFloat(t.caluteData.jcAmount1).toFixed(0)))]),
                      c('td', [t._v(t._s(parseFloat(t.caluteData.jcAmount2).toFixed(0)))]),
                      c('td', [t._v(t._s(parseFloat(t.caluteData.hgAmount1).toFixed(0)))]),
                      c('td', [t._v(t._s(parseFloat(t.caluteData.hgAmount2).toFixed(0)))]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('利润')]),
                      c('td', { attrs: { colspan: '4' } }, [
                        t._v(' ' + t._s(parseFloat(t.caluteData.profit).toFixed(0)) + ' '),
                      ]),
                    ]),
                  ]),
                  c(
              ...
              c(
                ...
                [
                  c('div', { staticStyle: { display: 'flex' } }, [
                    c(
                      'div',
                      ...
                      [
                        c(
                          'el-table',
                          { key: t.isKey, attrs: { data: t.twoDatas, border: '', fit: '', 'show-header': !1 } },
                          [
                            c('el-table-column', {
                              attrs: { label: '赛事', width: '180', align: 'center' },
                              scopedSlots: t._u([
                                {
                                  key: 'default',
                                  fn: function (a) {
                                      ...
                                      c(
                                        ...
                                        [
                                          c(
                                            ...
                                            [t._v(t._s(a.row.jcMatch.matchNumStr))]
                                          ),
                                          c('br'),
                                          t._v(' ' + t._s(a.row.jcMatch.matchTimeFormat)),
                                          c('br'),
                                        ]
                                      ),
                                      c(
                                        ...
                                        [
                                          c(
                                            'span',
                                            {
                                              ...
                                              attrs: { title: a.row.hgMatch.leagueAbbName },
                                            },
                                            [t._v('【' + t._s(a.row.hgMatch.leagueAbbName) + '】')]
                                          ),
                                          c('br'),
                                          c('span', { staticStyle: { color: 'red' } }, [
                                            t._v(t._s(a.row.hgMatch.homeTeamAbbName)),
                                          ]),
                                          t._v(' VS '),
                                          c('span', { staticStyle: { color: 'blue' } }, [
                            ...
                            c('el-table-column', {
                              attrs: { label: 'JC投注', align: 'center' },
                              scopedSlots: t._u([
                                {
                                  key: 'default',
                                  fn: function (a) {
                                    return [
                                      '3' === a.row.jcMatch.matchNumStr.slice(2, 3)
                                        ? c(
                                            'div',
                                            ...
                                            [
                                              c(
                                                ...
                                                { attrs: { gutter: 20 } },
                                                [
                                                  c('el-col', { attrs: { span: 6 } }, [t._v(' 类型 ')]),
                                                  c('el-col', { attrs: { span: 9 } }, [
                                                    t._v(
                                                      ' ' +
                                                        t._s(
                                                          '大小' === a.row.jcodds[0].type.slice(0, 2) ? '大' : '主负'
                                                        ) +
                                                        ' '
                                                    ),
                                                  ]),
                                                  c('el-col', { attrs: { span: 9 } }, [
                                                    t._v(
                                                      ' ' +
                                                        t._s(
                                                          '大小' === a.row.jcodds[0].type.slice(0, 2) ? '小' : '主胜'
                                                        ) +
                                                        ' '
                                                    ),
                                                  ]),
                                              ...
                                              t._l(a.row.jcodds, function (e, i) {
                                                return c(
                                                  'el-row',
                                                  { key: i, attrs: { gutter: 20 } },
                                                  [
                                                    c(
                                                      'el-popover',
                                                      {
                                                        attrs: { placement: 'left', width: '260', trigger: 'hover' },
                                                        on: {
                                                          show: function (c) {
                                                      ...
                                                      [
                                                        c('div', { attrs: { id: 'oddsChgDiv' } }, [
                                                          c(
                                                            ...
                                                            [
                                                              t._v(
                                                                ' ' +
                                                                  t._s(a.row.jcMatch.homeTeamAbbName) +
                                                                  ' VS ' +
                                                                  t._s(a.row.jcMatch.awayTeamAbbName) +
                                                                  ' 奖金变化 '
                                                              ),
                                                            ]
                                                          ),
                                                          c('div', { staticClass: 'OpenDivTop' }, [
                                                            c(
                                                              'table',
                                                              {
                                                              ...
                                                              [
                                                                c(
                                                                  'tbody',
                                                                  [
                                                                    c('tr', { attrs: { bgcolor: '#F0F8FF' } }, [
                                                                      c('td', [t._v('胜')]),
                                                                      c('td', [t._v('平')]),
                                                                      c('td', [t._v('负')]),
                                                                      c('td', [t._v('时间')]),
                                                                    ]),
                                                                    t._l(t.arrChgOdds, function (a, e) {
                                                                      return c('tr', { key: e }, [
                                                                        c(
                                                                          'td',
                                                                          [
                                                                        ...
                                                                        c('td', [
                                                                          t._v(
                                                                            ' ' +
                                                                              t._s(a.updateDate.slice(5)) +
                                                                              ' ' +
                                                                              t._s(a.updateTime.slice(0, 5)) +
                                                                              ' '
                                                                          ),
                                                                        ]),
                                                                      ]);
                                                        ...
                                                        c(
                                                          'el-col',
                                                          { attrs: { slot: 'reference', span: 6 }, slot: 'reference' },
                                                          [t._v(' ' + t._s(e.type) + ' ')]
                                                        ),
                                                      ],
                                                      1
                                                    ...
                                                    c(
                                                      ...
                                                      {
                                                        class:
                                                          a.row.jctz[e.goalLine] &&
                                                          (a.row.jctz[e.goalLine].indexOf('a') > -1 ||
                                                            a.row.jctz[e.goalLine].indexOf('d') > -1)
                                                            ? 'selecttd'
                                                            : '',
                                                        attrs: { span: 9 },
                                                      },
                                                    ...
                                                    c(
                                                      'el-col',
                                                      {
                                                        class:
                                                          a.row.jctz[e.goalLine] &&
                                                          (a.row.jctz[e.goalLine].indexOf('h') > -1 ||
                                                            a.row.jctz[e.goalLine].indexOf('x') > -1)
                                                            ? 'selecttd'
                                                            : '',
                                                        attrs: { span: 9 },
                                                      },
                                        ...
                                        : c(
                                            ...
                                            [
                                              c(
                                                ...
                                                [
                                                  c('el-col', { attrs: { span: 6 } }, [t._v(' 类型 ')]),
                                                  c('el-col', { attrs: { span: 6 } }, [t._v(' 胜 ')]),
                                                  c('el-col', { attrs: { span: 6 } }, [t._v(' 平 ')]),
                                                  c('el-col', { attrs: { span: 6 } }, [t._v(' 负 ')]),
                                                ],
                                                1
                                              ),
                                              t._l(a.row.jcodds, function (e, i) {
                            ...
                            c('el-table-column', {
                              attrs: { 'class-name': 'status-col', label: '平台投注', align: 'center' },
                              scopedSlots: t._u([
                                {
                                  key: 'default',
                                  fn: function (a) {
                                            ...
                                            [
                                              a.row.hgodds[0]
                                                      ...
                                                      c('el-col', { attrs: { span: 9 } }, [
                                                        t._v(
                                                          ' ' +
                                                            t._s(
                                                              a.row.hgodds[0] &&
                                                                '大小' === a.row.hgodds[0].type.slice(0, 2)
                                                                ? '大'
                                                                : a.row.hgMatch.homeTeamAbbName
                                                            ) +
                                                            ' '
                                                        ),
                                                      ]),
                                                ...
                                                : c(
                                                    'el-row',
                                                    [
                                                      c('el-col', { attrs: { span: 24 } }, [
                                                        t._v(' ' + t._s(a.row.error) + ' '),
                                                      ]),
                                                    ],
                                                    1
                                                  ),
                                              t._l(a.row.hgodds, function (e, i) {
                                                return c(
                                                  'el-row',
                                                  {
                                                    key: i,
                                                    ...
                                                    c(
                                                      ...
                                                      [
                                                        ...
                                                        c(
                                                          ...
                                                          {
                                                            class:
                                                              a.row.hgtz[e.goalLine] &&
                                                              (a.row.hgtz[e.goalLine].indexOf('h') > -1 ||
                                                                a.row.hgtz[e.goalLine].indexOf('d') > -1)
                                                                ? 'selecttd'
                                                                : '',
                                                            attrs: { span: 9 },
                                                          },
                                                        ...
                                                        c(
                                                          'el-col',
                                                          {
                                                            class:
                                                              a.row.hgtz[e.goalLine] &&
                                                              (a.row.hgtz[e.goalLine].indexOf('a') > -1 ||
                                                                a.row.hgtz[e.goalLine].indexOf('x') > -1)
                                                                ? 'selecttd'
                                                                : '',
                                                            attrs: { span: 9 },
                                                          },
                    ...
                    c('div', { staticClass: 'leftbox' }, [
                      c('table', { staticClass: 'dangtable cctable' }, [
                        c('tr', [
                          c(
                            'td',
                            { staticStyle: { padding: '5px 0', 'font-size': '16px' }, attrs: { colspan: '3' } },
                            [
                              t._v(' ' + t._s(t.cccaluteData.planId && t.cccaluteData.planId.replace(/%0A/, ' '))),
                              c(
                                'el-button',
                                {
                                  attrs: { size: 'mini', type: 'primary' },
                                  on: {
                                    click: function (a) {
                                      (t.seltgame = t.cccaluteData.planId),
                                        ...
                                        (t.sportteryUrl =
                                          'lqdg' == t.gametype
                                            ? 'http://175.27.134.229/sporttery/lqhhgg.html'
                                            : 'http://175.27.134.229/sporttery');
                                    },
                                  },
                                },
                                [t._v(' 截图 ')]
                          ...
                          c(
                            'td',
                            { staticStyle: { padding: '5px 0' }, attrs: { colspan: '2' } },
                            [
                              t._v(' 第一场 '),
                              c(
                                'el-select',
                        ...
                        c('tr', [
                          c(
                            'td',
                            { staticStyle: { padding: '1px 0' }, attrs: { colspan: '3' } },
                            [
                              t._v(' JC返点： '),
                              c('el-input-number', {
                                staticStyle: { 'margin-right': '20px', 'font-size': '20px', width: '120px' },
                                attrs: { 'controls-position': 'right', precision: 3, step: 0.01, size: 'small' },
                                on: {
                                  change: function (a) {
                          ...
                          c(
                            'td',
                            { staticStyle: { padding: '1px 0' }, attrs: { colspan: '4' } },
                            [
                              t._v(' HG返点： '),
                              c('el-input-number', {
                                staticStyle: { 'margin-right': '20px', width: '120px' },
                                attrs: { 'controls-position': 'right', precision: 3, step: 0.001, size: 'small' },
                                on: {
                                  change: function (a) {
                                    return t.computeDatacc();
                                  },
                        ...
                        c('tr', [
                          ...
                          c(
                            'td',
                            { staticStyle: { width: '200px' }, attrs: { colspan: '2' } },
                            [
                              c('el-input-number', {
                                staticStyle: { width: '120px' },
                                attrs: { size: 'small', step: 0.01 },
                            ...
                            [
                              c('el-input-number', {
                                ...
                                attrs: {
                                  ...
                                  step: 0.01,
                                  disabled:
                                    t.seltztype && '2' !== t.seltztype.slice(-1) && '3' !== t.seltztype.slice(-1),
                                },
                                on: {
                                  change: function (a) {
                                    return t.computeDatacc();
                        ...
                        c('tr', { staticStyle: { color: 'red', background: '#ecf5ff' } }, [
                          ...
                          c('td', [
                            c('span', [
                              t._v(t._s(t.cccaluteData.HGTzAmt1_1 && parseFloat(t.cccaluteData.HGTzAmt1_1).toFixed(0))),
                            ]),
                          ]),
                          c('td', [
                            c('span', [
                              t._v(t._s(t.cccaluteData.HGTzAmt1_2 && parseFloat(t.cccaluteData.HGTzAmt1_2).toFixed(0))),
                            ]),
                          ]),
                          c('td', [
                            c('span', [
                              t._v(t._s(t.cccaluteData.HGTzAmt2_1 && parseFloat(t.cccaluteData.HGTzAmt2_1).toFixed(0))),
                            ]),
                          ]),
                          c('td', [
                            c('span', [
                              t._v(t._s(t.cccaluteData.HGTzAmt2_2 && parseFloat(t.cccaluteData.HGTzAmt2_2).toFixed(0))),
                            ]),
                          ]),
                        ]),
                        c('tr', { staticStyle: { color: '#817d7d' } }, [
                          c('td', { staticStyle: { width: '10%' } }, [t._v('中奖')]),
                          c('td', { attrs: { colspan: '2' } }, [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.JCAmount && parseFloat(t.cccaluteData.JCAmount).toFixed(0)) +
                                ' '
                            ),
                          ]),
                          c('td', [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HGAmount1_1 && parseFloat(t.cccaluteData.HGAmount1_1).toFixed(0)) +
                                ' '
                            ),
                          ]),
                          c('td', [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HGAmount1_2 && parseFloat(t.cccaluteData.HGAmount1_2).toFixed(0)) +
                                ' '
                            ),
                          ]),
                          c('td', [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HGAmount2_1 && parseFloat(t.cccaluteData.HGAmount2_1).toFixed(0)) +
                                ' '
                            ),
                          ]),
                          c('td', [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HGAmount2_2 && parseFloat(t.cccaluteData.HGAmount2_2).toFixed(0)) +
                                ' '
                            ),
                          ]),
                        ]),
                        c('tr', [
                          c('td', { staticStyle: { width: '10%' } }, [t._v('利润')]),
                          c('td', { staticClass: 'star-chose', attrs: { colspan: '2' } }, [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.JcProfit && parseFloat(t.cccaluteData.JcProfit).toFixed(0)) +
                                ' '
                            ),
                          ]),
                          c('td', { staticClass: 'star-chose', attrs: { colspan: '2' } }, [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HgProfit1 && parseFloat(t.cccaluteData.HgProfit1).toFixed(0)) +
                                ' '
                            ),
                            c('span', {
                              class: { 'el-icon-star-off': !t.firStar },
                            ...
                            c('span', {
                              class: { 'el-icon-star-on': t.firStar },
                              staticStyle: { 'font-size': '22px', cursor: 'pointer', color: 'green' },
                              on: {
                                click: function (a) {
                          ...
                          c('td', { staticClass: 'star-chose', attrs: { colspan: '2' } }, [
                            t._v(
                              ' ' +
                                t._s(t.cccaluteData.HgProfit2 && parseFloat(t.cccaluteData.HgProfit2).toFixed(0)) +
                                ' '
                            ),
                            c('span', {
                              class: { 'el-icon-star-off': !t.secStar },
                              staticStyle: { 'font-size': '20px', cursor: 'pointer' },
                              on: {
                                click: function (a) {
                            ...
                            c('span', {
                              class: { 'el-icon-star-on': t.secStar },
                              staticStyle: { 'font-size': '22px', cursor: 'pointer', color: 'green' },
                              on: {
                                click: function (a) {
                      ...
                      c(
                        ...
                        [
                          ...
                          t._v(' 自定义：'),
                          c('el-input-number', {
                            attrs: { precision: 5, size: 'mini', step: 0.001 },
                            on: {
                              change: function (a) {
                                return t.computeDatacc();
                              },
                          ...
                          t._v(' 备注：'),
                          c('el-input', {
                            staticStyle: { display: 'inline-block', width: '220px' },
                            model: {
              ...
              c(
                ...
                [
                  c('table', { staticClass: 'dangtable' }, [
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          t._v(' JC投注总金额： '),
                          c('el-input', {
                            staticStyle: { width: '100px', 'margin-right': '60px' },
                            attrs: { size: 'small' },
                            on: {
                              change: function (a) {
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('0球')]),
                          c('br'),
                          c('el-input-number', {
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('1球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('2球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('3球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('4球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('5球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('6球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('7+球')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(
                              t._s(
                                t.ttgCalData.HGgoalLine1
                                  ? t.getText(t.ttgCalData.HGTouz1, t.ttgCalData.HGgoalLine1)
                                  : ''
                              )
                            ),
                          ]),
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(
                              t._s(
                                t.ttgCalData.HGgoalLine2
                                  ? t.getText(t.ttgCalData.HGTouz2, t.ttgCalData.HGgoalLine2)
                                  : '无需投注'
                              )
                            ),
                          ]),
                    ...
                    c('tr', [
                      c('td', { staticStyle: { width: '20%' } }, [t._v('中奖金额')]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt0))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt1))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt2))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt3))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt4))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt5))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.JCZjAmt6))])]),
                      c('td', [c('span', [t._v(t._s(this.ttgCalData.JCZjAmt7))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.HGZjAmt1))])]),
                      c('td', [c('span', [t._v(t._s(t.ttgCalData.HGZjAmt2))])]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('利润')]),
                      c('td', { attrs: { colspan: '10' } }, [t._v(' ' + t._s(t.ttgCalData.profit) + ' ')]),
                    ]),
                  ]),
                  c(
                    'span',
              ...
              c(
                ...
                [
                  c('table', { staticClass: 'dangtable' }, [
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          t._v(' JC投注总金额： '),
                          c('el-input', {
                            staticStyle: { width: '120px', 'margin-right': '60px' },
                            attrs: { size: 'small' },
                            on: {
                              change: function (a) {
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('胜胜')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('胜平')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('胜负')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('平胜')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('平平')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('平负')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('负胜')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('负平')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          ...
                          c('br'),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [t._v('负负')]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(
                              t._s(
                                t.hafuCalData.HGgoalLine1
                                  ? t.getText(t.hafuCalData.HGTouz1, t.hafuCalData.HGgoalLine1)
                                  : ''
                              )
                            ),
                          ]),
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(
                              t._s(
                                t.hafuCalData.HGgoalLine2
                                  ? t.getText(t.hafuCalData.HGTouz2, t.hafuCalData.HGgoalLine2)
                                  : ''
                              )
                            ),
                          ]),
                    ...
                    c('tr', [
                      c('td', { staticStyle: { width: '20%' } }, [t._v('中奖金额')]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_hh))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_hd))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_ha))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_dh))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_dd))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_da))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_ah))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_ad))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.JCZjAmt_aa))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.HGZjAmt_1))])]),
                      c('td', [c('span', [t._v(t._s(t.hafuCalData.HGZjAmt_2))])]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('利润')]),
                      c('td', { attrs: { colspan: '11' } }, [t._v(' ' + t._s(t.hafuCalData.profit) + ' ')]),
                    ]),
                  ]),
                  c(
                    'span',
              ...
              c(
                ...
                [
                  c('table', { staticClass: 'dangtable' }, [
                    c('tr', [
                      c('td', { attrs: { colspan: '6' } }, [
                        t._v(
                          ' [' +
                            t._s(t.matchInfo1.matchNumStr) +
                            '] ' +
                            t._s(t.matchInfo1.matchTimeFormat) +
                            ' 【' +
                            t._s(t.matchInfo1.leagueAbbName) +
                            '】'
                        ),
                        c('span', { staticStyle: { color: 'blue' } }, [t._v(t._s(t.matchInfo1.homeTeamAbbName))]),
                        t._v(' VS '),
                        c('span', { staticStyle: { color: 'red' } }, [t._v(t._s(t.matchInfo1.awayTeamAbbName))]),
                        c('br'),
                        t._v(
                          ' [' +
                            t._s(t.matchInfo2.matchNumStr) +
                            '] ' +
                            t._s(t.matchInfo2.matchTimeFormat) +
                            ' 【' +
                            t._s(t.matchInfo2.leagueAbbName) +
                            '】'
                        ),
                        c('span', { staticStyle: { color: 'blue' } }, [t._v(t._s(t.matchInfo2.homeTeamAbbName))]),
                        t._v(' VS '),
                        c('span', { staticStyle: { color: 'red' } }, [t._v(t._s(t.matchInfo2.awayTeamAbbName))]),
                      ]),
                      c(
                        'td',
                        { attrs: { colspan: '1' } },
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          t._v(' JC返点1： '),
                          c('el-input-number', {
                            staticStyle: { 'margin-right': '20px', width: '110px' },
                            attrs: { 'controls-position': 'right', precision: 3, step: 0.01, size: 'small' },
                            on: {
                              change: function (a) {
                    ...
                    c('tr', [
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.qbcaluteData.JCTouz1_1, t.qbcaluteData.JCgoalLine1_1))),
                          ]),
                          t._v(' X '),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.qbcaluteData.JCTouz1_2, t.qbcaluteData.JCgoalLine1_2))),
                          ]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.qbcaluteData.JCTouz2_1, t.qbcaluteData.JCgoalLine2_1))),
                          ]),
                          t._v('X '),
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getTextJC(t.qbcaluteData.JCTouz2_2, t.qbcaluteData.JCgoalLine2_2))),
                          ]),
                          c('br'),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getText(t.qbcaluteData.HGTouz1_1, t.qbcaluteData.HGgoalLine1_1))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: { size: 'small', step: 0.01 },
                      ...
                      c(
                        ...
                        [
                          c('span', { staticStyle: { color: 'rgb(0, 168, 118)' } }, [
                            t._v(t._s(t.getText(t.qbcaluteData.HGTouz1_2, t.qbcaluteData.HGgoalLine1_2))),
                          ]),
                          c('el-input-number', {
                            staticStyle: { width: '110px' },
                            attrs: {
                    ...
                    c('tr', { staticStyle: { color: 'red', background: '#ecf5ff' } }, [
                      ...
                      c('td', { attrs: { colspan: '2' } }, [c('span', [t._v(t._s(t.qbcaluteData.JCTzAmt2))])]),
                      c('td', [c('span', [t._v(t._s(t.qbcaluteData.HGTzAmt1))])]),
                      c('td', [c('span', [t._v(t._s(t.qbcaluteData.HGTzAmt2))])]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('中奖金额')]),
                      c('td', { attrs: { colspan: '2' } }, [t._v(' ' + t._s(t.qbcaluteData.JCAmount1) + ' ')]),
                      c('td', { attrs: { colspan: '2' } }, [t._v(' ' + t._s(t.qbcaluteData.JCAmount2) + ' ')]),
                      c('td', [t._v(t._s(t.qbcaluteData.HGAmount1))]),
                      c('td', [t._v(t._s(t.qbcaluteData.HGAmount2))]),
                    ]),
                    c('tr', [
                      c('td', { staticStyle: { width: '10%' } }, [t._v('利润')]),
                      c('td', { attrs: { colspan: '6' } }, [t._v(' ' + t._s(t.qbcaluteData.profit) + ' ')]),
                    ]),
                  ]),
                  c(
                    'span',
          ...
          function () {
            ...
            return c(
              ...
              [
                ...
                c('breadcrumb', { staticClass: 'breadcrumb-container' }),
                c(
                  'div',
                  ...
                  [
                    c(
                      ...
                      [
                        c('div', { staticClass: 'avatar-wrapper' }, [
                          c('span', { staticStyle: { color: 'red' } }, [
                            t._v(
                              ' ' +
                                t._s(t.viptime ? t.dateFormat(new Date(t.viptime), 'yyyy-MM-dd hh:mm:ss') : '') +
                                '到期 '
                            ),
                          ]),
                          c('img', { staticClass: 'user-avatar', attrs: { src: e('09b1') } }),
                          c('i', { staticClass: 'el-icon-caret-bottom' }),
                        ]),
                        c(
                          'el-dropdown-menu',
                          { staticClass: 'user-dropdown', attrs: { slot: 'dropdown' }, slot: 'dropdown' },
                          [
                            c('router-link', { attrs: { to: '/' } }, [c('el-dropdown-item', [t._v(' Home ')])], 1),
                            c(
                              'el-dropdown-item',
                              {
                                attrs: { divided: '' },
                              ...
                              [c('span', { staticStyle: { display: 'block' } }, [t._v('Log Out')])]
                            ),
                          ],
                          1
                        ),
        ...
        d = [],
        f = e('5530'),
        m = (e('00b4'), e('4d63'), e('c607'), e('2c3e'), e('2f62')),
        p = function () {
          var t = this,
            a = t.$createElement,
            e = t._self._c || a;
            ...
            [
              e(
                ...
                t._l(t.levelList, function (a, c) {
                  return e('el-breadcrumb-item', { key: a.path }, [
                    'noRedirect' === a.redirect || c == t.levelList.length - 1
                      ? e('span', { staticClass: 'no-redirect' }, [t._v(t._s(a.meta.title))])
                      : e(
                          'a',
                          {
                            on: {
                              click: function (e) {
                                return e.preventDefault(), t.handleLink(a);
                              },
                            },
                          },
          ...
          methods: {
            getBreadcrumb: function () {
              var t = this.$route.matched.filter(function (t) {
                ...
                a = t[0];
              this.isDashboard(a) || (t = [{ path: '/dashboard', meta: { title: 'Dashboard' } }].concat(t)),
        ...
        b = _,
        v = (e('14ec'), e('2877')),
        z = Object(v['a'])(b, p, C, !1, null, 'a963f6d0', null),
        y = z.exports,
        j = function () {
          var t = this,
            a = t.$createElement,
            e = t._self._c || a;
          return e('div', { staticStyle: { padding: '0 15px' }, on: { click: t.toggleClick } }, [
            e(
              'svg',
              {
        ...
        x = J,
        A = (e('e7e7'), Object(v['a'])(x, j, T, !1, null, '351820a6', null)),
        w = A.exports,
        B = {
          components: { Breadcrumb: y, Hamburger: w },
          ...
          methods: {
            dateFormat: function (t, a) {
              ...
              for (var c in (/(y+)/.test(a) &&
                (a = a.replace(RegExp.$1, (t.getFullYear() + '').substr(4 - RegExp.$1.length))),
              e))
                new RegExp('(' + c + ')').test(a) &&
                  (a = a.replace(RegExp.$1, 1 === RegExp.$1.length ? e[c] : ('00' + e[c]).substr(('' + e[c]).length)));
              return a;
            },
                  ...
                  return Object(r['a'])().wrap(function (a) {
                    while (1)
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (a.next = 2), t.$store.dispatch('user/logout');
                        case 2:
        ...
        k = B,
        S = (e('32e5'), Object(v['a'])(k, h, d, !1, null, '24d508f3', null)),
        O = S.exports,
        F = function () {
          var t = this,
            a = t.$createElement,
          ...
          return e(
            'div',
            { class: { 'has-logo': t.showLogo } },
            [
              t.showLogo ? e('logo', { attrs: { collapse: t.isCollapse } }) : t._e(),
              e(
                'el-scrollbar',
        ...
        G = function () {
          ...
          return c(
            'div',
            { staticClass: 'sidebar-logo-container', class: { collapse: t.collapse } },
            [
              c(
                'transition',
                ...
                [
                  t.collapse
                    ? c('router-link', { key: 'collapse', staticClass: 'sidebar-logo-link', attrs: { to: '/' } }, [
                        c('img', { staticClass: 'sidebar-logo', attrs: { src: e('4ffd') } }),
                      ])
                    : c('router-link', { key: 'expand', staticClass: 'sidebar-logo-link', attrs: { to: '/' } }, [
                        c('h1', { staticClass: 'sidebar-title' }, [t._v(' 红单分析 ')]),
                      ]),
                ],
                1
              ),
        ...
        L = {
          ...
          data: function () {
            return { title: '红单分析', logo: 'https://wpimg.wallstcn.com/69a1c46c-eb1c-4b46-8bd4-e9e686ef5251.png' };
          },
        },
        M = L,
        P = (e('e23b'), Object(v['a'])(M, G, q, !1, null, '6f274a1c', null)),
        I = P.exports,
        R = function () {
          var t = this,
            a = t.$createElement,
          ...
          return t.item.hidden
            ...
            : e(
                ...
                [
                  ...
                  (t.onlyOneChild.children && !t.onlyOneChild.noShowingChildren) ||
                  t.item.alwaysShow
                    ? e(
                        'el-submenu',
                        { ref: 'subMenu', attrs: { index: t.resolvePath(t.item.path), 'popper-append-to-body': '' } },
                        [
                          e(
                            'template',
                            { slot: 'title' },
                            [
                              t.item.meta
                                ? e('item', {
                                    attrs: { icon: t.item.meta && t.item.meta.icon, title: t.item.meta.title },
                                  })
                                : t._e(),
                            ],
                            1
                          ),
                          t._l(t.item.children, function (a) {
                            return e('sidebar-item', {
                              key: a.path,
                              staticClass: 'nest-menu',
                              attrs: { 'is-nest': !0, item: a, 'base-path': t.resolvePath(a.path) },
                            });
                          }),
                        ],
                        2
          ...
          e('2532'),
          {
            ...
            render: function (t, a) {
              ...
              return (
                c &&
                  (c.includes('el-icon')
                    ? n.push(t('i', { class: [c, 'sub-el-icon'] }))
                    : n.push(t('svg-icon', { attrs: { 'icon-class': c } }))),
                i && n.push(t('span', { slot: 'title' }, [i])),
                n
              );
            },
          }),
        U = Z,
        W = (e('f15b'), Object(v['a'])(U, c, i, !1, null, '18eeea00', null)),
        X = W.exports,
        Q = function () {
          var t = this,
            a = t.$createElement,
            e = t._self._c || a;
          return e(t.type, t._b({ tag: 'component' }, 'component', t.linkProps(t.to), !1), [t._t('default')], 2);
        },
        K = [],
        Y = {
          ...
          methods: {
            linkProps: function (t) {
              return this.isExternal ? { href: t, target: '_blank', rel: 'noopener' } : { to: t };
            },
          },
        },
        tt = Y,
        at = Object(v['a'])(tt, Q, K, !1, null, null, null),
        et = at.exports,
        ct = {
          computed: {
            device: function () {
        ...
        it = {
          ...
          methods: {
            hasOneShowingChild: function () {
              var t = this,
                ...
                c = a.filter(function (a) {
                  return !a.hidden && ((t.onlyOneChild = a), !0);
                });
              return (
                1 === c.length ||
                (0 === c.length &&
                  ((this.onlyOneChild = Object(f['a'])(Object(f['a'])({}, e), {}, { path: '', noShowingChildren: !0 })),
                  !0))
              );
            },
            resolvePath: function (t) {
              return Object(E['a'])(t)
                ? t
                : Object(E['a'])(this.basePath)
                ? this.basePath
                : V.a.resolve(this.basePath, t);
            },
          },
        },
        nt = it,
        ot = Object(v['a'])(nt, R, $, !1, null, null, null),
        lt = ot.exports,
        st = e('cf1e'),
        rt = e.n(st),
        ut = {
          components: { SidebarItem: lt, Logo: I },
          computed: Object(f['a'])(
            Object(f['a'])(Object(f['a'])({}, Object(m['b'])(['sidebar'])), Object(m['b'])(['role', 'name'])),
            {},
            {
              routes: function () {
                return 'admin' === this.role
                  ? this.$router.options.routes
                  : this.$router.options.routes.filter(function (t) {
        ...
        ht = ut,
        dt = Object(v['a'])(ht, F, H, !1, null, null, null),
        ft = dt.exports,
        mt = function () {
          var t = this,
            a = t.$createElement,
        ...
        Ct = {
          name: 'AppMain',
          props: { configData: Object, planList: Array, hisPlanList: Array, flashFlag: Boolean, selectMactch: String },
          computed: {
            key: function () {
        ...
        gt = Ct,
        Dt = (e('5b23'), e('c2cc'), Object(v['a'])(gt, mt, pt, !1, null, '738f9500', null)),
        _t = Dt.exports,
        bt = e('4360'),
        vt = document,
        zt = vt.body,
        ...
        jt = {
          watch: {
            $route: function (t) {
              'mobile' === this.device &&
                this.sidebar.opened &&
                bt['a'].dispatch('app/closeSideBar', { withoutAnimation: !1 });
            },
          },
          ...
          mounted: function () {
            ...
            t &&
              (bt['a'].dispatch('app/toggleDevice', 'mobile'),
              bt['a'].dispatch('app/closeSideBar', { withoutAnimation: !0 }));
          },
          methods: {
            $_isMobile: function () {
            ...
            $_resizeHandler: function () {
              if (!document.hidden) {
                ...
                bt['a'].dispatch('app/toggleDevice', t ? 'mobile' : 'desktop'),
                  t && bt['a'].dispatch('app/closeSideBar', { withoutAnimation: !0 });
              }
            },
          },
        },
        Tt = e('b775');
      function Jt(t) {
        return Object(Tt['a'])({ url: '/water/caculateSin', method: 'post', data: t });
      }
      function xt(t) {
        return Object(Tt['a'])({ url: '/water/caculateQB', method: 'post', data: t });
      }
      function At(t) {
        return Object(Tt['a'])({ url: '/water/caculateChuan', method: 'post', data: t });
      }
      function wt(t) {
        return Object(Tt['a'])({ url: '/water/caculateTotalGoal', method: 'post', data: t });
      }
      function Bt(t) {
        return Object(Tt['a'])({ url: '/water/caculateBQC', method: 'post', data: t });
      }
      var kt = e('9d9f'),
        St = { findall: '/matchs/getMatchById' };
      function Ot(t) {
        return Object(Tt['a'])({ url: St.findall, method: 'get', params: t });
      }
      var Ft = { create: '/userConfig/create', findall: '/userConfig/getMyConfig', update: '/userConfig/update' };
      function Ht(t) {
        return Object(Tt['a'])({ url: Ft.findall, method: 'get', params: t });
      }
      function Gt(t) {
        return Object(Tt['a'])({
      ...
      var qt = e('5c96'),
        Lt = e('60a8'),
        Mt = e('0bb4'),
        Pt = { getVersion: '/jcmatch/version' };
      function It(t) {
        return Object(Tt['a'])({ url: Pt.getVersion, method: 'get', params: t });
      }
      var Rt = {
          name: 'Layout',
          components: { Navbar: O, Sidebar: ft, AppMain: _t },
          mixins: [jt],
          data: function () {
            return {
              ifConfigGeted: !1,
              ...
              hafuCalData: { HGTzAmt: 1e4, TzAmt: 1e4, HGTzOdds: '', profit: '' },
              JCPointSin: '',
              JCPointChuan: '',
              configData: {
                JCPointSinLq: 0.07,
              ...
              arrdgtztype: [
                { value: 'WL', name: '生死' },
                { value: 'WLD1', name: '内平生死平' },
                { value: 'WLD2', name: '外平生死平' },
                { value: 'WH1', name: '内平赢一半' },
                { value: 'WH2', name: '外平赢一半' },
                { value: 'WH3', name: '内只平赢一半' },
                { value: 'D1', name: '内平手盘' },
                { value: 'D2', name: '外平手盘' },
                { value: 'D3', name: '内只平手盘' },
                { value: 'LH1', name: '内平输一半' },
                { value: 'LH2', name: '外平输一半' },
                { value: 'LH3', name: '内只平输一半' },
              ],
              seltztype: void 0,
              matchInfo: {},
              matchInfo1: {},
          ...
          mounted: function () {
            var t = this;
            Object(Mt['b'])({ state: 'open', sort: 'createdAt,DESC' }).then(function (a) {
              t.arrNotices = a.data;
            }),
              (this.versionTimer = setInterval(function () {
                Object(Mt['b'])({ state: 'open', sort: 'createdAt,DESC' }).then(function (a) {
                  ...
                  It({ _t: Math.random() }).then(function (a) {
                    t.version < a.value &&
                      t.$alert('请刷新网页获取最新版本', '版本更新', {
          ...
          created: function () {
            ...
            Ht()
              ...
              Object(kt['b'])({ delFlag: 1, sort: 'createdAt,ASC' }).then(function (a) {
                t.planList = a.data;
              });
          },
          beforeDestroy: function () {
          ...
          methods: {
            routerChange: function () {
              switch ((console.log(this.$route.name), this.$route.name)) {
                case '足球二串一':
            ...
            delPlan: function (t) {
              ...
              Object(kt['a'])(t).then(function () {
                a.$message({ message: '删除成功!', type: 'success' }),
                  Object(kt['b'])({ delFlag: 1, sort: 'createdAt,ASC' }).then(function (t) {
                    a.planList = t.data;
                  }),
                  0 == t.delFlag &&
                    Object(kt['b'])({ delFlag: 0, sort: 'createdAt,DESC' }).then(function (t) {
            ...
            showOddsChg: function (t, a) {
              var e = this;
              (this.arrChgOdds = []),
                Object(Lt['b'])({ matchId: a, poolCode: '-' === t ? 'had' : 'hhad' }).then(function (a) {
            ...
            setVedio: function () {
              ...
              (this.configData.danRadio = this.danRadio),
                ...
                Gt(this.configData).then(function (a) {
                  t.$message({ message: '保存成功!', type: 'success' });
                }),
                (this.vedioVisible = !1);
            },
            playVedio: function (t) {
              var a;
              '1' === t
                ? (a = document.getElementById('tsy1'))
                : '2' === t
                ? (a = document.getElementById('tsy2'))
                : '3' === t
                ? (a = document.getElementById('tsy3'))
                : '4' === t
                ? (a = document.getElementById('tsy4'))
                : '5' === t
                ? (a = document.getElementById('tsy5'))
                : '6' === t && (a = document.getElementById('tsy6')),
                a.play();
            },
            ...
            showhistoryplan: function (t) {
              ...
              0 == t
                ? (this.hisPlanList = [])
                : Object(kt['b'])({ delFlag: 0, sort: 'updatedAt,DESC', limit: 10 }).then(function (t) {
                    a.hisPlanList = t.data;
                  });
            },
            savePlan: function () {
                    ...
                    while (1)
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (
                            (e = 1),
                            0 == t.cccaluteData.delFlag && ((t.cccaluteData.delFlag = 1), (e = 0)),
                            ...
                            (t.cccaluteData.planName1 = t.dealPlanName(
                              t.currJcMatch1.matchNumStr,
                              t.cccaluteData.JCTouz1,
                              t.cccaluteData.JCgoalLine1,
                              t.cccaluteData.JCTzOdd1,
                              t.gametype
                            )),
                            (t.cccaluteData.planName2 = t.dealPlanName(
                              t.currJcMatch2.matchNumStr,
                              t.cccaluteData.JCTouz2,
                              t.cccaluteData.JCgoalLine2,
                              t.cccaluteData.JCTzOdd2,
                              t.gametype
                            )),
                            t.cccaluteData.planName1 &&
                              t.cccaluteData.planName2 &&
                              (t.cccaluteData.planId = t.cccaluteData.planName1 + '%0A' + t.cccaluteData.planName2),
                            (a.next = 12),
                            t.computeDatacc()
                          );
                        case 12:
                          Object(kt['c'])(t.cccaluteData).then(function (a) {
                            t.$message({ message: '保存成功!', type: 'success' }),
                              ...
                              0 == e &&
                                Object(kt['b'])({ delFlag: 0, sort: 'createdAt,DESC' }).then(function (a) {
            ...
            closePlan: function () {
              (this.cccalshow = !1), (this.cccaluteData.JCPoint = ''), (this.cccaluteData.HGPoint = '');
            },
            jietucc: function (t, a, e, c) {
              ...
              var i = '',
                n = '';
              switch (
                (t['JCgoalLine' + a + '_1'] && '-' !== t['JCgoalLine' + a + '_1']
                  ? (i = '让')
                  : t['JCgoalLine' + a + '_1'] && '-' === t['JCgoalLine' + a + '_1'] && (i = ''),
                t['JCTouz' + a + '_1'])
              ) {
                case 'h':
                  i += '胜';
              ...
              switch (
                (t['JCgoalLine' + a + '_2'] && '-' !== t['JCgoalLine' + a + '_2']
                  ? (n = '让')
                  : t['JCgoalLine' + a + '_2'] && '-' === t['JCgoalLine' + a + '_2'] && (n = ''),
                t['JCTouz' + a + '_2'])
              ) {
                case 'h':
                  n += '胜';
              ...
              (this.seltgame = ''
                .concat(e.matchNumStr)
                .concat(i)
                .concat(t['JCTzOdd' + a + '_1'])),
                n &&
                  (this.seltgame += '%0A'
                    .concat(c.matchNumStr)
                    .concat(n)
                    .concat(t['JCTzOdd' + a + '_2'])),
                (this.jietuVisible = !0);
            },
            jietu: function (t, a) {
              var e = '',
              ...
              if ('lqdg' == a) {
                if (
                  ((this.sportteryUrl = 'http://175.27.134.229/sporttery/lqhhgg.html'),
                  ...
                  switch (((e = ''), this.caluteData.JCTouz1)) {
                    case 'h':
                      e += '主胜';
                      break;
                    case 'a':
                ...
                if (this.caluteData.JCgoalLine2 && '-' !== this.caluteData.JCgoalLine2)
                  ...
                  switch (((c = ''), this.caluteData.JCTouz2)) {
                    case 'h':
                      c += '主胜';
                      break;
                    case 'a':
                ...
                switch (
                  ...
                  this.caluteData.JCgoalLine1 && '-' !== this.caluteData.JCgoalLine1
                    ? (e = '让')
                    : this.caluteData.JCgoalLine1 && '-' === this.caluteData.JCgoalLine1 && (e = ''),
                ...
                switch (
                  (this.caluteData.JCgoalLine2 && '-' !== this.caluteData.JCgoalLine2
                    ? (c = '让')
                    : this.caluteData.JCgoalLine2 && '-' === this.caluteData.JCgoalLine2 && (c = ''),
            ...
            jietuttg: function (t, a) {
              (this.seltgame = ''), (this.sportteryUrl = 'http://175.27.134.229/sporttery/');
              var e = t.matchNumStr;
              -1 == a
                ? (this.ttgCalData.JCTzAmt0 &&
                    0 != this.ttgCalData.JCTzAmt0 &&
                    (e += ' 0球' + t.ttg_s0 + ' ' + Math.floor(this.ttgCalData.JCTzAmt0)),
                  this.ttgCalData.JCTzAmt1 &&
                    0 != this.ttgCalData.JCTzAmt1 &&
                    (e += ' 1球' + t.ttg_s1 + ' ' + Math.floor(this.ttgCalData.JCTzAmt1)),
                  this.ttgCalData.JCTzAmt2 &&
                    0 != this.ttgCalData.JCTzAmt2 &&
                    (e += ' 2球' + t.ttg_s2 + ' ' + Math.floor(this.ttgCalData.JCTzAmt2)),
                  this.ttgCalData.JCTzAmt3 &&
                    0 != this.ttgCalData.JCTzAmt3 &&
                    (e += ' 3球' + t.ttg_s3 + ' ' + Math.floor(this.ttgCalData.JCTzAmt3)),
                  this.ttgCalData.JCTzAmt4 &&
                    0 != this.ttgCalData.JCTzAmt4 &&
                    (e += ' 4球' + t.ttg_s4 + ' ' + Math.floor(this.ttgCalData.JCTzAmt4)),
                  this.ttgCalData.JCTzAmt5 &&
                    0 != this.ttgCalData.JCTzAmt5 &&
                    (e += ' 5球' + t.ttg_s5 + ' ' + Math.floor(this.ttgCalData.JCTzAmt5)),
                  this.ttgCalData.JCTzAmt6 &&
                    0 != this.ttgCalData.JCTzAmt6 &&
                    (e += ' 6球' + t.ttg_s6 + ' ' + Math.floor(this.ttgCalData.JCTzAmt6)),
                  this.ttgCalData.JCTzAmt7 &&
                    0 != this.ttgCalData.JCTzAmt7 &&
                    (e += ' 7球' + t.ttg_s7 + ' ' + Math.floor(this.ttgCalData.JCTzAmt7)))
                : 0 == a && this.ttgCalData.JCTzAmt0 && 0 != this.ttgCalData.JCTzAmt0
                ? (e += ' 0球' + t.ttg_s0 + ' ' + Math.floor(this.ttgCalData.JCTzAmt0))
                : 1 == a && this.ttgCalData.JCTzAmt1 && 0 != this.ttgCalData.JCTzAmt1
                ? (e += ' 1球' + t.ttg_s1 + ' ' + Math.floor(this.ttgCalData.JCTzAmt1))
                : 2 == a && this.ttgCalData.JCTzAmt2 && 0 != this.ttgCalData.JCTzAmt2
                ? (e += ' 2球' + t.ttg_s2 + ' ' + Math.floor(this.ttgCalData.JCTzAmt2))
                : 3 == a && this.ttgCalData.JCTzAmt3 && 0 != this.ttgCalData.JCTzAmt3
                ? (e += ' 3球' + t.ttg_s3 + ' ' + Math.floor(this.ttgCalData.JCTzAmt3))
                : 4 == a && this.ttgCalData.JCTzAmt4 && 0 != this.ttgCalData.JCTzAmt4
                ? (e += ' 4球' + t.ttg_s4 + ' ' + Math.floor(this.ttgCalData.JCTzAmt4))
                : 5 == a && this.ttgCalData.JCTzAmt5 && 0 != this.ttgCalData.JCTzAmt5
                ? (e += ' 5球' + t.ttg_s5 + ' ' + Math.floor(this.ttgCalData.JCTzAmt5))
                : 6 == a && this.ttgCalData.JCTzAmt6 && 0 != this.ttgCalData.JCTzAmt6
                ? (e += ' 6球' + t.ttg_s6 + ' ' + Math.floor(this.ttgCalData.JCTzAmt6))
                : 7 == a &&
                  this.ttgCalData.JCTzAmt7 &&
                  0 != this.ttgCalData.JCTzAmt7 &&
            ...
            jietubqc: function (t, a) {
              ...
              var e = t.matchNumStr;
              -1 == a
                ? (this.hafuCalData.jcBet_hh &&
                    0 != this.hafuCalData.jcBet_hh &&
                    (e += ' 胜胜' + t.hafu_hh + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_hh / 100)),
                  this.hafuCalData.jcBet_hd &&
                    0 != this.hafuCalData.jcBet_hd &&
                    (e += ' 胜平' + t.hafu_hd + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_hd / 100)),
                  this.hafuCalData.jcBet_ha &&
                    0 != this.hafuCalData.jcBet_ha &&
                    (e += ' 胜负' + t.hafu_ha + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ha / 100)),
                  this.hafuCalData.jcBet_dh &&
                    0 != this.hafuCalData.jcBet_dh &&
                    (e += ' 平胜' + t.hafu_dh + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_dh / 100)),
                  this.hafuCalData.jcBet_dd &&
                    0 != this.hafuCalData.jcBet_dd &&
                    (e += ' 平平' + t.hafu_dd + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_dd / 100)),
                  this.hafuCalData.jcBet_da &&
                    0 != this.hafuCalData.jcBet_da &&
                    (e += ' 平负' + t.hafu_da + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_da / 100)),
                  this.hafuCalData.jcBet_ah &&
                    0 != this.hafuCalData.jcBet_ah &&
                    (e += ' 负胜' + t.hafu_ah + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ah / 100)),
                  this.hafuCalData.jcBet_ad &&
                    0 != this.hafuCalData.jcBet_ad &&
                    (e += ' 负平' + t.hafu_ad + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ad / 100)),
                  this.hafuCalData.jcBet_aa &&
                    0 != this.hafuCalData.jcBet_aa &&
                    (e += ' 负负' + t.hafu_aa + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_aa / 100)))
                : 'hh' == a && this.hafuCalData.jcBet_hh && 0 != this.hafuCalData.jcBet_hh
                ? (e += ' 胜胜' + t.hafu_hh + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_hh / 100))
                : 'hd' == a && this.hafuCalData.jcBet_hd && 0 != this.hafuCalData.jcBet_hd
                ? (e += ' 胜平' + t.hafu_hd + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_hd / 100))
                : 'ha' == a && this.hafuCalData.jcBet_ha && 0 != this.hafuCalData.jcBet_ha
                ? (e += ' 胜负' + t.hafu_ha + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ha / 100))
                : 'dh' == a && this.hafuCalData.jcBet_dh && 0 != this.hafuCalData.jcBet_dh
                ? (e += ' 平胜' + t.hafu_dh + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_dh / 100))
                : 'dd' == a && this.hafuCalData.jcBet_dd && 0 != this.hafuCalData.jcBet_dd
                ? (e += ' 平平' + t.hafu_dd + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_dd / 100))
                : 'da' == a && this.hafuCalData.jcBet_da && 0 != this.hafuCalData.jcBet_da
                ? (e += ' 平负' + t.hafu_da + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_da / 100))
                : 'ah' == a && this.hafuCalData.jcBet_ah && 0 != this.hafuCalData.jcBet_ah
                ? (e += ' 负胜' + t.hafu_ah + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ah / 100))
                : 'ad' == a && this.hafuCalData.jcBet_ad && 0 != this.hafuCalData.jcBet_ad
                ? (e += ' 负平' + t.hafu_ad + ' ' + 100 * Math.floor(this.hafuCalData.jcBet_ad / 100))
                : 'aa' == a &&
                  this.hafuCalData.jcBet_aa &&
                  0 != this.hafuCalData.jcBet_aa &&
            ...
            ttgCopy: function (t, a, e, c) {
              ...
              -1 == c
                ? 1 == e
                  ? (t.JCTzAmt0 &&
                      0 != t.JCTzAmt0 &&
                      (i += ' 0球' + a.ttg_s0 + ' ' + 100 * Math.round(t.JCTzAmt0 / 100)),
                    t.JCTzAmt1 &&
                      0 != t.JCTzAmt1 &&
                      (i += ' 1球' + a.ttg_s1 + ' ' + 100 * Math.round(t.JCTzAmt1 / 100)),
                    t.JCTzAmt2 &&
                      0 != t.JCTzAmt2 &&
                      (i += ' 2球' + a.ttg_s2 + ' ' + 100 * Math.round(t.JCTzAmt2 / 100)),
                    t.JCTzAmt3 &&
                      0 != t.JCTzAmt3 &&
                      (i += ' 3球' + a.ttg_s3 + ' ' + 100 * Math.round(t.JCTzAmt3 / 100)),
                    t.JCTzAmt4 &&
                      0 != t.JCTzAmt4 &&
                      (i += ' 4球' + a.ttg_s4 + ' ' + 100 * Math.round(t.JCTzAmt4 / 100)),
                    t.JCTzAmt5 &&
                      0 != t.JCTzAmt5 &&
                      (i += ' 5球' + a.ttg_s5 + ' ' + 100 * Math.round(t.JCTzAmt5 / 100)),
                    t.JCTzAmt6 &&
                      0 != t.JCTzAmt6 &&
                      (i += ' 6球' + a.ttg_s6 + ' ' + 100 * Math.round(t.JCTzAmt6 / 100)),
                    t.JCTzAmt7 &&
                      0 != t.JCTzAmt7 &&
                      (i += ' 7+球' + a.ttg_s7 + ' ' + 100 * Math.round(t.JCTzAmt7 / 100)))
                  : (t.JCTzAmt0 && 0 != t.JCTzAmt0 && (i += ' 0球' + a.ttg_s0 + ' ' + Math.floor(t.JCTzAmt0)),
                    ...
                    t.JCTzAmt7 && 0 != t.JCTzAmt7 && (i += ' 7+球' + a.ttg_s7 + ' ' + Math.floor(t.JCTzAmt7)))
                : 1 == e
                ? 0 == c && t.JCTzAmt0 && 0 != t.JCTzAmt0
                  ? (i += ' 0球' + a.ttg_s0 + ' ' + 100 * Math.round(t.JCTzAmt0 / 100))
                  : 1 == c && t.JCTzAmt1 && 0 != t.JCTzAmt1
                  ? (i += ' 1球' + a.ttg_s1 + ' ' + 100 * Math.round(t.JCTzAmt1 / 100))
                  : 2 == c && t.JCTzAmt2 && 0 != t.JCTzAmt2
                  ? (i += ' 2球' + a.ttg_s2 + ' ' + 100 * Math.round(t.JCTzAmt2 / 100))
                  : 3 == c && t.JCTzAmt3 && 0 != t.JCTzAmt3
                  ? (i += ' 3球' + a.ttg_s3 + ' ' + 100 * Math.round(t.JCTzAmt3 / 100))
                  : 4 == c && t.JCTzAmt4 && 0 != t.JCTzAmt4
                  ? (i += ' 4球' + a.ttg_s4 + ' ' + 100 * Math.round(t.JCTzAmt4 / 100))
                  : 5 == c && t.JCTzAmt5 && 0 != t.JCTzAmt5
                  ? (i += ' 5球' + a.ttg_s5 + ' ' + 100 * Math.round(t.JCTzAmt5 / 100))
                  : 6 == c && t.JCTzAmt6 && 0 != t.JCTzAmt6
                  ? (i += ' 6球' + a.ttg_s6 + ' ' + 100 * Math.round(t.JCTzAmt6 / 100))
                  : 7 == c &&
                    t.JCTzAmt7 &&
                    0 != t.JCTzAmt7 &&
                    (i += ' 7+球' + a.ttg_s7 + ' ' + 100 * Math.round(t.JCTzAmt7 / 100))
                : 0 == c && t.JCTzAmt0 && 0 != t.JCTzAmt0
                ? (i += ' 0球' + a.ttg_s0 + ' ' + Math.floor(t.JCTzAmt0))
                : 1 == c && t.JCTzAmt1 && 0 != t.JCTzAmt1
                ? (i += ' 1球' + a.ttg_s1 + ' ' + Math.floor(t.JCTzAmt1))
                : 2 == c && t.JCTzAmt2 && 0 != t.JCTzAmt2
                ? (i += ' 2球' + a.ttg_s2 + ' ' + Math.floor(t.JCTzAmt2))
                : 3 == c && t.JCTzAmt3 && 0 != t.JCTzAmt3
                ? (i += ' 3球' + a.ttg_s3 + ' ' + Math.floor(t.JCTzAmt3))
                : 4 == c && t.JCTzAmt4 && 0 != t.JCTzAmt4
                ? (i += ' 4球' + a.ttg_s4 + ' ' + Math.floor(t.JCTzAmt4))
                : 5 == c && t.JCTzAmt5 && 0 != t.JCTzAmt5
                ? (i += ' 5球' + a.ttg_s5 + ' ' + Math.floor(t.JCTzAmt5))
                : 6 == c && t.JCTzAmt6 && 0 != t.JCTzAmt6
                ? (i += ' 6球' + a.ttg_s6 + ' ' + Math.floor(t.JCTzAmt6))
                : 7 == c && t.JCTzAmt7 && 0 != t.JCTzAmt7 && (i += ' 7+球' + a.ttg_s7 + ' ' + Math.floor(t.JCTzAmt7)),
                console.log(t, a, e, c);
            ...
            bqcCopy: function (t, a, e, c) {
              ...
              1 == e
                ? -1 == c
                  ? (t.jcBet_hh &&
                      0 != t.jcBet_hh &&
                      (i += ' 胜胜' + a.hafu_hh + ' ' + 100 * Math.round(t.jcBet_hh / 100)),
                    t.jcBet_hd &&
                      0 != t.jcBet_hd &&
                      (i += ' 胜平' + a.hafu_hd + ' ' + 100 * Math.round(t.jcBet_hd / 100)),
                    t.jcBet_ha &&
                      0 != t.jcBet_ha &&
                      (i += ' 胜负' + a.hafu_ha + ' ' + 100 * Math.round(t.jcBet_ha / 100)),
                    t.jcBet_dh &&
                      0 != t.jcBet_dh &&
                      (i += ' 平胜' + a.hafu_dh + ' ' + 100 * Math.round(t.jcBet_dh / 100)),
                    t.jcBet_dd &&
                      0 != t.jcBet_dd &&
                      (i += ' 平平' + a.hafu_dd + ' ' + 100 * Math.round(t.jcBet_dd / 100)),
                    t.jcBet_da &&
                      0 != t.jcBet_da &&
                      (i += ' 平负' + a.hafu_da + ' ' + 100 * Math.round(t.jcBet_da / 100)),
                    t.jcBet_ah &&
                      0 != t.jcBet_ah &&
                      (i += ' 负胜' + a.hafu_ah + ' ' + 100 * Math.round(t.jcBet_ah / 100)),
                    t.jcBet_ad &&
                      0 != t.jcBet_ad &&
                      (i += ' 负平' + a.hafu_ad + ' ' + 100 * Math.round(t.jcBet_ad / 100)),
                    t.jcBet_aa &&
                      0 != t.jcBet_aa &&
                      (i += ' 负负' + a.hafu_aa + ' ' + 100 * Math.round(t.jcBet_aa / 100)))
                  : 'hh' == c && t.jcBet_hh && 0 != t.jcBet_hh
                  ? (i += ' 胜胜' + a.hafu_hh + ' ' + 100 * Math.round(t.jcBet_hh / 100))
                  : 'hd' == c && t.jcBet_hd && 0 != t.jcBet_hd
                  ? (i += ' 胜平' + a.hafu_hd + ' ' + 100 * Math.round(t.jcBet_hd / 100))
                  : 'ha' == c && t.jcBet_ha && 0 != t.jcBet_ha
                  ? (i += ' 胜负' + a.hafu_ha + ' ' + 100 * Math.round(t.jcBet_ha / 100))
                  : 'dh' == c && t.jcBet_dh && 0 != t.jcBet_dh
                  ? (i += ' 平胜' + a.hafu_dh + ' ' + 100 * Math.round(t.jcBet_dh / 100))
                  : 'dd' == c && t.jcBet_dd && 0 != t.jcBet_dd
                  ? (i += ' 平平' + a.hafu_dd + ' ' + 100 * Math.round(t.jcBet_dd / 100))
                  : 'da' == c && t.jcBet_da && 0 != t.jcBet_da
                  ? (i += ' 平负' + a.hafu_da + ' ' + 100 * Math.round(t.jcBet_da / 100))
                  : 'ah' == c && t.jcBet_ah && 0 != t.jcBet_ah
                  ? (i += ' 负胜' + a.hafu_ah + ' ' + 100 * Math.round(t.jcBet_ah / 100))
                  : 'ad' == c && t.jcBet_ad && 0 != t.jcBet_ad
                  ? (i += ' 负平' + a.hafu_ad + ' ' + 100 * Math.round(t.jcBet_ad / 100))
                  : 'aa' == c &&
                    t.jcBet_aa &&
                    0 != t.jcBet_aa &&
                    (i += ' 负负' + a.hafu_aa + ' ' + 100 * Math.round(t.jcBet_aa / 100))
                : -1 == c
                ? (t.jcBet_hh && 0 != t.jcBet_hh && (i += ' 胜胜' + a.hafu_hh + ' ' + Math.floor(t.jcBet_hh)),
                  ...
                  t.jcBet_aa && 0 != t.jcBet_aa && (i += ' 负负' + a.hafu_aa + ' ' + Math.floor(t.jcBet_aa)))
                : 'hh' == c && t.jcBet_hh && 0 != t.jcBet_hh
                ? (i += ' 胜胜' + a.hafu_hh + ' ' + Math.floor(t.jcBet_hh))
                : 'hd' == c && t.jcBet_hd && 0 != t.jcBet_hd
                ? (i += ' 胜平' + a.hafu_hd + ' ' + Math.floor(t.jcBet_hd))
                : 'ha' == c && t.jcBet_ha && 0 != t.jcBet_ha
                ? (i += ' 胜负' + a.hafu_ha + ' ' + Math.floor(t.jcBet_ha))
                : 'dh' == c && t.jcBet_dh && 0 != t.jcBet_dh
                ? (i += ' 平胜' + a.hafu_dh + ' ' + Math.floor(t.jcBet_dh))
                : 'dd' == c && t.jcBet_dd && 0 != t.jcBet_dd
                ? (i += ' 平平' + a.hafu_dd + ' ' + Math.floor(t.jcBet_dd))
                : 'da' == c && t.jcBet_da && 0 != t.jcBet_da
                ? (i += ' 平负' + a.hafu_da + ' ' + Math.floor(t.jcBet_da))
                : 'ah' == c && t.jcBet_ah && 0 != t.jcBet_ah
                ? (i += ' 负胜' + a.hafu_ah + ' ' + Math.floor(t.jcBet_ah))
                : 'ad' == c && t.jcBet_ad && 0 != t.jcBet_ad
                ? (i += ' 负平' + a.hafu_ad + ' ' + Math.floor(t.jcBet_ad))
                : 'aa' == c &&
                  t.jcBet_aa &&
                  0 != t.jcBet_aa &&
                  (i += ' 负负' + a.hafu_aa + ' ' + Math.floor(t.jcBet_aa));
              var n = document.createElement('input');
              n.setAttribute('readonly', 'readonly'),
                n.setAttribute('value', i),
                document.body.appendChild(n),
            ...
            clearCcData: function (t) {
              1 === t
                ? ((this.cccaluteData.method1 = ''),
                  ...
                  (this.cccaluteData.HgProfit1_2 = ''))
                : ((this.cccaluteData.method2 = ''),
            ...
            calculatetmp: function () {
              this.$route.path.indexOf('ttg') > -1
                ? (this.ttgCalShow = !0)
                : this.$route.path.indexOf('allin') > -1
                ? ((this.matchInfo1 = {}), (this.matchInfo2 = {}), (this.qbShowCal = !0))
                : (this.dialogVisible = !0);
            },
            dealShowData: function (t, a, e) {
              this.twoDatas[t - 1] = { jctz: {}, hgtz: {} };
              var c = 'zq';
              ...
              '-' === i
                ...
                : i === a.hilo_goalLine
                ? (this.twoDatas[t - 1].jcodds = [
                    { type: '大小> ' + a.hilo_goalLine, a: a.hilo_a, h: a.hilo_h, goalLine: a.hilo_goalLine },
                  ])
                : (this.twoDatas[t - 1].jcodds = [
                    {
              ...
              if (((this.twoDatas[t - 1].hgodds = []), n && '-' === n))
              ...
              if (
                (n && (this.twoDatas[t - 1].hgtz[n] = this.cccaluteData['HGTouz'.concat(t, '_1')]),
                o &&
                  (this.twoDatas[t - 1].hgtz[o] = this.twoDatas[t - 1].hgtz[o]
                    ? this.twoDatas[t - 1].hgtz[o] + this.cccaluteData['HGTouz'.concat(t, '_2')]
                    : this.cccaluteData['HGTouz'.concat(t, '_2')]),
                o && '-' === o && o !== n)
              )
                this.twoDatas[t - 1].hgodds.push({ type: '独赢', a: e.had_a, h: e.had_h, d: e.had_d, goalLine: '-' });
              ...
              this.clearCcData(i),
                ...
                1 === i
                  ? ((this.currJcMatch1 = e),
                    ...
                    (this.cccaluteData.planName1 = this.dealPlanName(
                      e.matchNumStr,
                      a.data.JCTouz1,
                      a.data.JCgoalLine1,
                      a.data.jcOdds1,
                  ...
                  : 2 === i &&
                    ...
                    (this.cccaluteData.planName2 = this.dealPlanName(
                      e.matchNumStr,
                      a.data.JCTouz1,
                      a.data.JCgoalLine1,
                      a.data.jcOdds1,
                ...
                (this.cccalshow = !0),
                this.cccaluteData.planName1 &&
                  this.cccaluteData.planName2 &&
                  ((this.cccaluteData.planId = this.cccaluteData.planName1 + '%0A' + this.cccaluteData.planName2),
                  this.computeDatacc());
            },
                    ...
                    while (1)
                      switch ((a.prev = a.next)) {
                        case 0:
                          ...
                          return (a.next = 3), Ot({ matchId: t.currJcMatch1.matchId });
                        case 3:
                          (o = a.sent), (o = o.data), (e = o.JCFootBoll), (i = o.HGFootBoll);
                        case 7:
                          if (!t.currJcMatch2) {
                            a.next = 14;
                            break;
                          }
                          return (a.next = 10), Ot({ matchId: t.currJcMatch2.matchId });
                        case 10:
                          (l = a.sent), (l = l.data), (c = l.JCFootBoll), (n = l.HGFootBoll);
                        case 14:
                          (t.currJcMatch1 = e),
                            (t.currJcMatch2 = c),
                    ...
                    while (1)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (e.next = 11), Ot({ matchId: a.cccaluteData.matchId1, type: l });
                        case 11:
                          (s = e.sent), (s = s.data), (c = s.JCFootBoll), (n = s.HGFootBoll);
                        case 15:
                          if (i && o) {
                            e.next = 22;
                            break;
                          }
                          return (e.next = 18), Ot({ matchId: a.cccaluteData.matchId2, type: l });
                        case 18:
                          (u = e.sent), (u = u.data), (i = u.JCFootBoll), (o = u.HGFootBoll);
                        case 22:
                          '3' === c.matchNumStr.slice(2, 3) ? (a.gametype = 'lqdg') : (a.gametype = ''),
                            ...
                            (a.cccaluteData.planName1 = a.dealPlanName(
                              c.matchNumStr,
                              a.cccaluteData.JCTouz1,
                              a.cccaluteData.JCgoalLine1,
                              a.cccaluteData.JCTzOdd1,
                              a.gametype
                            )),
                            (a.cccaluteData.planName2 = a.dealPlanName(
                              i.matchNumStr,
                              a.cccaluteData.JCTouz2,
                              a.cccaluteData.JCgoalLine2,
                              a.cccaluteData.JCTzOdd2,
                              a.gametype
                            )),
                            a.cccaluteData.planName1 &&
                              a.cccaluteData.planName2 &&
                              (a.cccaluteData.planId = a.cccaluteData.planName1 + '%0A' + a.cccaluteData.planName2),
                  ...
                  return Object(r['a'])().wrap(function (c) {
                    while (1)
                      switch ((c.prev = c.next)) {
                        case 0:
                          return (
                            (e.hafuCalData.modifyFlag = !1),
                            'jc' === t
                              ? ((e.hafuCalData.JCTzAmt = e.hafuCalData['jcBet_' + a]),
                                (e.hafuCalData.consult = 'jcBet_' + a))
                              : 'hg' === t
                              ? ((e.hafuCalData.JCTzAmt = e.hafuCalData[a]), (e.hafuCalData.consult = a))
                              : ('yh' !== t && t) ||
                                ((e.hafuCalData.modifyFlag = !0),
                                a && a.indexOf('hgBet') > -1
                                  ? ((e.hafuCalData.JCTzAmt = e.hafuCalData[a]), (e.hafuCalData.consult = a))
                                  : a
                                  ? ((e.hafuCalData.JCTzAmt = e.hafuCalData['jcBet_' + a]),
                                    (e.hafuCalData.consult = 'jcBet_' + a))
                                  : e.hafuCalData.jcBet_hh && 0 != e.hafuCalData.jcBet_hh
                                  ? (e.hafuCalData.consult = 'jcBet_hh')
                                  : e.hafuCalData.jcBet_hd && 0 != e.hafuCalData.jcBet_hd
                                  ? (e.hafuCalData.consult = 'jcBet_hd')
                                  : e.hafuCalData.jcBet_ha && 0 != e.hafuCalData.jcBet_ha
                                  ? (e.hafuCalData.consult = 'jcBet_ha')
                                  : e.hafuCalData.jcBet_dh && 0 != e.hafuCalData.jcBet_dh
                                  ? (e.hafuCalData.consult = 'jcBet_dh')
                                  : e.hafuCalData.jcBet_dd && 0 != e.hafuCalData.jcBet_dd
                                  ? (e.hafuCalData.consult = 'jcBet_dd')
                                  : e.hafuCalData.jcBet_da && 0 != e.hafuCalData.jcBet_da
                                  ? (e.hafuCalData.consult = 'jcBet_hd')
                                  : e.hafuCalData.jcBet_ah && 0 != e.hafuCalData.jcBet_ah
                                  ? (e.hafuCalData.consult = 'jcBet_ah')
                                  : e.hafuCalData.jcBet_ad && 0 != e.hafuCalData.jcBet_ad
                                  ? (e.hafuCalData.consult = 'jcBet_ad')
                                  : e.hafuCalData.jcBet_aa &&
                                    0 != e.hafuCalData.jcBet_aa &&
                                    (e.hafuCalData.consult = 'jcBet_aa')),
                            e.hafuCalData.consult ||
                              (parseInt(e.hafuCalData.jcBet_hh) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_hh),
                                  (e.hafuCalData.consult = 'jcBet_hh'))
                                : parseInt(e.hafuCalData.jcBet_hd) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_hd),
                                  (e.hafuCalData.consult = 'jcBet_hd'))
                                : parseInt(e.hafuCalData.jcBet_ha) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_ha),
                                  (e.hafuCalData.consult = 'jcBet_ha'))
                                : parseInt(e.hafuCalData.jcBet_dh) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_dh),
                                  (e.hafuCalData.consult = 'jcBet_dh'))
                                : parseInt(e.hafuCalData.jcBet_dd) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_dd),
                                  (e.hafuCalData.consult = 'jcBet_dd'))
                                : parseInt(e.hafuCalData.jcBet_da) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_da),
                                  (e.hafuCalData.consult = 'jcBet_da'))
                                : parseInt(e.hafuCalData.jcBet_ah) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_ah),
                                  (e.hafuCalData.consult = 'jcBet_ah'))
                                : parseInt(e.hafuCalData.jcBet_ad) === parseInt(e.configData.JCTzAmt)
                                ? ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_ad),
                                  (e.hafuCalData.consult = 'jcBet_ad'))
                                : parseInt(e.hafuCalData.jcBet_aa) === parseInt(e.configData.JCTzAmt) &&
                                  ((e.hafuCalData.JCTzAmt = e.hafuCalData.jcBet_aa),
                                  (e.hafuCalData.consult = 'jcBet_aa'))),
                            (c.next = 5),
                            Bt(e.hafuCalData)
                          );
                        case 5:
                          (i = c.sent),
                            ...
                            (e.hafuCalData.HGZjAmt_1 = (
                              parseFloat(n.hgBet1) * parseFloat(e.hafuCalData.hgOdds1)
                            ).toFixed(0)),
                            e.hafuCalData.hgBet2 && e.hafuCalData.hgOdds2
                              ? (e.hafuCalData.HGZjAmt_2 = (
                                  parseFloat(n.hgBet2) * parseFloat(e.hafuCalData.hgOdds2)
                                ).toFixed(0))
                              : (e.hafuCalData.HGZjAmt_2 = 0),
                            e.hafuCalData.jcBet_hh && 0 != parseFloat(e.hafuCalData.jcBet_hh) && e.hafuCalData.hafu_hh
                              ? (e.hafuCalData.JCZjAmt_hh = (
                                  parseFloat(e.hafuCalData.jcBet_hh) * parseFloat(e.hafuCalData.hafu_hh)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_hh = 0),
                            e.hafuCalData.jcBet_hd && 0 != parseFloat(e.hafuCalData.jcBet_hd) && e.hafuCalData.hafu_hd
                              ? (e.hafuCalData.JCZjAmt_hd = (
                                  parseFloat(e.hafuCalData.jcBet_hd) * parseFloat(e.hafuCalData.hafu_hd)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_hd = 0),
                            e.hafuCalData.jcBet_ha && 0 != parseFloat(e.hafuCalData.jcBet_ha) && e.hafuCalData.hafu_ha
                              ? (e.hafuCalData.JCZjAmt_ha = (
                                  parseFloat(e.hafuCalData.jcBet_ha) * parseFloat(e.hafuCalData.hafu_ha)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_ha = 0),
                            e.hafuCalData.jcBet_dh && 0 != parseFloat(e.hafuCalData.jcBet_dh) && e.hafuCalData.hafu_dh
                              ? (e.hafuCalData.JCZjAmt_dh = (
                                  parseFloat(e.hafuCalData.jcBet_dh) * parseFloat(e.hafuCalData.hafu_dh)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_dh = 0),
                            e.hafuCalData.jcBet_dd && 0 != parseFloat(e.hafuCalData.jcBet_dd) && e.hafuCalData.hafu_dd
                              ? (e.hafuCalData.JCZjAmt_dd = (
                                  parseFloat(e.hafuCalData.jcBet_dd) * parseFloat(e.hafuCalData.hafu_dd)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_dd = 0),
                            e.hafuCalData.jcBet_da && 0 != parseFloat(e.hafuCalData.jcBet_da) && e.hafuCalData.hafu_da
                              ? (e.hafuCalData.JCZjAmt_da = (
                                  parseFloat(e.hafuCalData.jcBet_da) * parseFloat(e.hafuCalData.hafu_da)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_da = 0),
                            e.hafuCalData.jcBet_ah && 0 != parseFloat(e.hafuCalData.jcBet_ah) && e.hafuCalData.hafu_ah
                              ? (e.hafuCalData.JCZjAmt_ah = (
                                  parseFloat(e.hafuCalData.jcBet_ah) * parseFloat(e.hafuCalData.hafu_ah)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_ah = 0),
                            e.hafuCalData.jcBet_ad && 0 != parseFloat(e.hafuCalData.jcBet_ad) && e.hafuCalData.hafu_ad
                              ? (e.hafuCalData.JCZjAmt_ad = (
                                  parseFloat(e.hafuCalData.jcBet_ad) * parseFloat(e.hafuCalData.hafu_ad)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_ad = 0),
                            e.hafuCalData.jcBet_aa && 0 != parseFloat(e.hafuCalData.jcBet_aa) && e.hafuCalData.hafu_aa
                              ? (e.hafuCalData.JCZjAmt_aa = (
                                  parseFloat(e.hafuCalData.jcBet_aa) * parseFloat(e.hafuCalData.hafu_aa)
                                ).toFixed(0))
                              : (e.hafuCalData.jcBet_aa = 0),
                    ...
                    while (1)
                      switch ((c.prev = c.next)) {
                        case 0:
                          return (
                            'yh' !== t && t
                              ? (e.ttgCalData.modifyFlag = !1)
                              : (a
                                  ? ((e.ttgCalData.TzAmt = e.ttgCalData['JCTzAmt' + a]),
                                    (e.ttgCalData.consult = 'JC' + a))
                                  : ((e.ttgCalData.TzAmt = e.ttgCalData.HGTzAmt1), (e.ttgCalData.consult = 'HG')),
                                (e.ttgCalData.modifyFlag = !0),
                                (e.ttgCalData.ttgTzAmt = e.ttgCalData.ttgTzAmt)),
                            'jc' === t
                              ? ((e.ttgCalData.TzAmt = e.ttgCalData['JCTzAmt' + a]), (e.ttgCalData.consult = 'JC' + a))
                              : 'hg' === t
                              ? ((e.ttgCalData.TzAmt = e.ttgCalData.HGTzAmt1), (e.ttgCalData.consult = 'HG'))
                              : 'hg2' === t &&
                                ((e.ttgCalData.TzAmt = e.ttgCalData.HGTzAmt2), (e.ttgCalData.consult = 'HG2')),
                            (c.next = 4),
                            wt(e.ttgCalData)
                          );
                        case 4:
                          (i = c.sent),
                            ...
                            n.JCTzAmt0 &&
                              n.JCTzOdds0 &&
                              '-' != n.JCTzOdds0 &&
                              (e.ttgCalData.JCZjAmt0 = (parseFloat(n.JCTzAmt0) * parseFloat(n.JCTzOdds0)).toFixed(0)),
                            n.JCTzAmt1 &&
                              n.JCTzOdds1 &&
                              '-' != n.JCTzOdds1 &&
                              (e.ttgCalData.JCZjAmt1 = (parseFloat(n.JCTzAmt1) * parseFloat(n.JCTzOdds1)).toFixed(0)),
                            n.JCTzAmt2 &&
                              n.JCTzOdds2 &&
                              '-' != n.JCTzOdds2 &&
                              (e.ttgCalData.JCZjAmt2 = (parseFloat(n.JCTzAmt2) * parseFloat(n.JCTzOdds2)).toFixed(0)),
                            n.JCTzAmt3 &&
                              n.JCTzOdds3 &&
                              '-' != n.JCTzOdds3 &&
                              (e.ttgCalData.JCZjAmt3 = (parseFloat(n.JCTzAmt3) * parseFloat(n.JCTzOdds3)).toFixed(0)),
                            n.JCTzAmt4 &&
                              n.JCTzOdds4 &&
                              '-' != n.JCTzOdds4 &&
                              (e.ttgCalData.JCZjAmt4 = (parseFloat(n.JCTzAmt4) * parseFloat(n.JCTzOdds4)).toFixed(0)),
                            n.JCTzAmt5 &&
                              n.JCTzOdds5 &&
                              '-' != n.JCTzOdds5 &&
                              (e.ttgCalData.JCZjAmt5 = (parseFloat(n.JCTzAmt5) * parseFloat(n.JCTzOdds5)).toFixed(0)),
                            n.JCTzAmt6 &&
                              n.JCTzOdds6 &&
                              '-' != n.JCTzOdds6 &&
                              (e.ttgCalData.JCZjAmt6 = (parseFloat(n.JCTzAmt6) * parseFloat(n.JCTzOdds6)).toFixed(0)),
                            n.JCTzAmt7 &&
                              n.JCTzOdds7 &&
                              '-' != n.JCTzOdds7 &&
                              (e.ttgCalData.JCZjAmt7 = (parseFloat(n.JCTzAmt7) * parseFloat(n.JCTzOdds7)).toFixed(0)),
                      ...
                      switch ((a.prev = a.next)) {
                        case 0:
                          return (
                            ...
                            (e.secJcOdds =
                              parseFloat(t.qbcaluteData.JCTzOdd2_1) * parseFloat(t.qbcaluteData.JCTzOdd2_2)),
                  ...
                  return Object(r['a'])().wrap(function (a) {
                    while (1)
                      switch ((a.prev = a.next)) {
                        ...
                        case 2:
                          return (t.caluteData.JCTzAmt = t.caluteData.jcBet1), (a.next = 5), Jt(t.caluteData);
                        case 5:
                          (e = a.sent),
                            (c = e && e.data),
            ...
            calculate: function (t) {
              (this.gametype = t.gametype), (this.caluteData = t.matchInfo.data);
              var a = t.JCInfos;
              (this.matchInfo = a[t.matchInfo.matchId]), (this.dialogVisible = !0);
            },
            ...
            ttgcalculate: function (t) {
              ...
              (this.matchInfo = a[t.matchInfo.matchId]),
                (this.ttgCalData.HGZjAmt1 = (
                  parseFloat(this.ttgCalData.HGTzAmt1) * parseFloat(this.ttgCalData.HGTzOdds1)
                ).toFixed(0)),
                (this.ttgCalData.HGZjAmt2 = (
                  parseFloat(this.ttgCalData.HGTzAmt2) * parseFloat(this.ttgCalData.HGTzOdds2)
                ).toFixed(0)),
                '-' == this.ttgCalData.HGTzOdds1 && (this.ttgCalData.HGZjAmt1 = 0),
                '-' == this.ttgCalData.HGTzOdds2 && (this.ttgCalData.HGZjAmt2 = 0),
                this.ttgCalData.JCTzAmt0 && this.ttgCalData.JCTzOdds0 && '-' != this.ttgCalData.JCTzOdds0
                  ? (this.ttgCalData.JCZjAmt0 = (
                      parseFloat(this.ttgCalData.JCTzAmt0) * parseFloat(this.ttgCalData.JCTzOdds0)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt0 = 0),
                this.ttgCalData.JCTzAmt1 && this.ttgCalData.JCTzOdds1 && '-' != this.ttgCalData.JCTzOdds1
                  ? (this.ttgCalData.JCZjAmt1 = (
                      parseFloat(this.ttgCalData.JCTzAmt1) * parseFloat(this.ttgCalData.JCTzOdds1)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt1 = 0),
                this.ttgCalData.JCTzAmt2 && this.ttgCalData.JCTzOdds2 && '-' != this.ttgCalData.JCTzOdds2
                  ? (this.ttgCalData.JCZjAmt2 = (
                      parseFloat(this.ttgCalData.JCTzAmt2) * parseFloat(this.ttgCalData.JCTzOdds2)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt2 = 0),
                this.ttgCalData.JCTzAmt3 && this.ttgCalData.JCTzOdds3 && '-' != this.ttgCalData.JCTzOdds3
                  ? (this.ttgCalData.JCZjAmt3 = (
                      parseFloat(this.ttgCalData.JCTzAmt3) * parseFloat(this.ttgCalData.JCTzOdds3)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt3 = 0),
                this.ttgCalData.JCTzAmt4 && this.ttgCalData.JCTzOdds4 && '-' != this.ttgCalData.JCTzOdds4
                  ? (this.ttgCalData.JCZjAmt4 = (
                      parseFloat(this.ttgCalData.JCTzAmt4) * parseFloat(this.ttgCalData.JCTzOdds4)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt4 = 0),
                this.ttgCalData.JCTzAmt5 && this.ttgCalData.JCTzOdds5 && '-' != this.ttgCalData.JCTzOdds5
                  ? (this.ttgCalData.JCZjAmt5 = (
                      parseFloat(this.ttgCalData.JCTzAmt5) * parseFloat(this.ttgCalData.JCTzOdds5)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt5 = 0),
                this.ttgCalData.JCTzAmt6 && this.ttgCalData.JCTzOdds6 && '-' != this.ttgCalData.JCTzOdds6
                  ? (this.ttgCalData.JCZjAmt6 = (
                      parseFloat(this.ttgCalData.JCTzAmt6) * parseFloat(this.ttgCalData.JCTzOdds6)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt6 = 0),
                this.ttgCalData.JCTzAmt7 && this.ttgCalData.JCTzOdds7 && '-' != this.ttgCalData.JCTzOdds7
                  ? (this.ttgCalData.JCZjAmt7 = (
                      parseFloat(this.ttgCalData.JCTzAmt7) * parseFloat(this.ttgCalData.JCTzOdds7)
                    ).toFixed(0))
                  : (this.ttgCalData.JCZjAmt7 = 0),
            ...
            hafucalculate: function (t) {
              ...
              var a = t.JCInfos;
              (this.matchInfo = a[t.matchInfo.matchId]),
                (this.hafuCalData.HGZjAmt_1 = (
                  parseFloat(this.hafuCalData.hgBet1) * parseFloat(this.hafuCalData.hgOdds1)
                ).toFixed(0)),
                this.hafuCalData.hgBet2 && this.hafuCalData.hgOdds2
                  ? (this.hafuCalData.HGZjAmt_2 = (
                      parseFloat(this.hafuCalData.hgBet2) * parseFloat(this.hafuCalData.hgOdds2)
                    ).toFixed(0))
                  : (this.hafuCalData.hgBet2 = 0),
                this.hafuCalData.jcBet_hh && this.hafuCalData.hafu_hh
                  ? (this.hafuCalData.JCZjAmt_hh = (
                      parseFloat(this.hafuCalData.jcBet_hh) * parseFloat(this.hafuCalData.hafu_hh)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_hh = 0),
                this.hafuCalData.jcBet_hd && this.hafuCalData.hafu_hd
                  ? (this.hafuCalData.JCZjAmt_hd = (
                      parseFloat(this.hafuCalData.jcBet_hd) * parseFloat(this.hafuCalData.hafu_hd)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_hd = 0),
                this.hafuCalData.jcBet_ha && this.hafuCalData.hafu_ha
                  ? (this.hafuCalData.JCZjAmt_ha = (
                      parseFloat(this.hafuCalData.jcBet_ha) * parseFloat(this.hafuCalData.hafu_ha)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_ha = 0),
                this.hafuCalData.jcBet_dh && this.hafuCalData.hafu_dh
                  ? (this.hafuCalData.JCZjAmt_dh = (
                      parseFloat(this.hafuCalData.jcBet_dh) * parseFloat(this.hafuCalData.hafu_dh)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_dh = 0),
                this.hafuCalData.jcBet_dd && this.hafuCalData.hafu_dd
                  ? (this.hafuCalData.JCZjAmt_dd = (
                      parseFloat(this.hafuCalData.jcBet_dd) * parseFloat(this.hafuCalData.hafu_dd)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_dd = 0),
                this.hafuCalData.jcBet_da && this.hafuCalData.hafu_da
                  ? (this.hafuCalData.JCZjAmt_da = (
                      parseFloat(this.hafuCalData.jcBet_da) * parseFloat(this.hafuCalData.hafu_da)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_da = 0),
                this.hafuCalData.jcBet_ah && this.hafuCalData.hafu_ah
                  ? (this.hafuCalData.JCZjAmt_ah = (
                      parseFloat(this.hafuCalData.jcBet_ah) * parseFloat(this.hafuCalData.hafu_ah)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_ah = 0),
                this.hafuCalData.jcBet_ad && this.hafuCalData.hafu_ad
                  ? (this.hafuCalData.JCZjAmt_ad = (
                      parseFloat(this.hafuCalData.jcBet_ad) * parseFloat(this.hafuCalData.hafu_ad)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_ad = 0),
                this.hafuCalData.jcBet_aa && this.hafuCalData.hafu_aa
                  ? (this.hafuCalData.JCZjAmt_aa = (
                      parseFloat(this.hafuCalData.jcBet_aa) * parseFloat(this.hafuCalData.hafu_aa)
                    ).toFixed(0))
                  : (this.hafuCalData.jcBet_aa = 0),
            ...
            getText: function (t, a) {
              ...
              var e = '';
              if ('-' === a) e += '独赢';
              else if ('J' === a.slice(0, 1)) e += '净胜' + a.slice(1, 2) + '球';
              else {
                    ...
                    if (!isNaN(i) && parseFloat(i) > 80)
                      'd' === t[i]
                        ? ((c.oddx = e[n]['h']),
                          (c.goalLinex = i),
                          (c.Touzx = t[i]),
                          (c.textx = this.getTextJC('d', e[n].goalLine)))
                        : 'x' === t[i] &&
                          ((c.oddx = e[n]['a']),
                          (c.goalLinex = i),
                          (c.Touzx = t[i]),
                      ...
                      for (var o = t[i].split(''), l = 0; l < o.length; l++)
                        'd' === o[l]
                          ? ((c.oddy = e[n][o[l]]),
                            (c.goalLiney = i),
                            (c.Touzy = t[i]),
                            (c.texty = this.getTextJC(o[l], e[n].goalLine)))
                          : ((c.oddx = e[n][o[l]]),
                            (c.goalLinex = i),
                            (c.Touzx = t[i]),
                    ...
                    if (s === e[r].goalLine)
                      if ('hj' === t[s] || 'aj' === t[s])
                        ...
                        for (var u = t[s].split(''), h = 0; h < u.length; h++)
                          'd' === u[h] ||
                          ('-' === s && 2 === t['-'].length && -1 === t['-'].indexOf('d') && 'h' === u[h])
                            ? ((c.oddx = e[r][u[h]]),
                              (c.goalLinex = s),
            ...
            comAccDiv: function (t, a) {
              var e,
                ...
                i = 0,
                n = 0;
              -1 === t.toString().indexOf('.') && (t += '.00'), -1 === a.toString().indexOf('.') && (a += '.00');
              try {
        ...
        $t = Rt,
        Nt = (e('9ba2'), Object(v['a'])($t, l, s, !1, null, '451594fe', null)),
        Vt = Nt.exports;
      n['default'].use(o['a']);
      var Et = [
          {
            ...
            children: [
              {
                ...
                meta: { title: '篮球二串一', icon: 'dashboard' },
              },
              {
                ...
                meta: { title: '篮球区间', icon: 'dashboard' },
              },
              {
                path: 'baskball/allin',
                name: '篮球全包',
                ...
                meta: { title: '篮球全包', icon: 'dashboard' },
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                meta: { title: '足球二串一', icon: 'dashboard' },
              },
              {
                path: 'football/ttg',
                name: '总进球数',
                ...
                meta: { title: '总进球数', icon: 'dashboard' },
              },
              {
                path: 'football/hafu',
                name: '半全场',
              ...
              },
              {
                ...
                meta: { title: '足球全包', icon: 'dashboard' },
              },
            ],
          },
          {
            ...
            children: [
              {
                ...
                meta: { title: 'JC>>HG适配器', icon: 'dashboard' },
              },
              {
                path: 'analysis/hgAdapter',
                name: '平台适配器',
                component: function () {
                  return e.e('chunk-2d79d2f7').then(e.bind(null, 'cc37'));
                },
                meta: { title: '平台适配器', icon: 'dashboard' },
              },
              {
            ...
            children: [
              {
                ...
                meta: { title: '球队设置', icon: 'dashboard' },
              },
              {
                path: 'system/userSet',
                name: '用户设置',
                component: function () {
                  return e.e('chunk-7f44009c').then(e.bind(null, '2ef8'));
                },
              ...
              },
              {
                ...
                meta: { title: 'uid管理', icon: 'dashboard' },
              },
              {
    ...
    b775: function (t, a, e) {
      ...
      var c = e('bc3a'),
        ...
        o = e('4360'),
        l = e('5f87'),
        s = i.a.create({ baseURL: '/api', timeout: 5e4 });
      s.interceptors.request.use(
        function (t) {
          return o['a'].getters.token && (t.headers['X-Token'] = Object(l['a'])()), t;
        },
        function (t) {
      ...
      var r = function (t) {
        if (t.response) {
          ...
          403 === t.response.status || 405 === t.response.status || 401 === t.response.status
      ...
      s.interceptors.response.use(
        function (t) {
          var a = t.data;
          return 200 !== a.code && !0 !== a.success
            ? (Object(n['Message'])({ message: a.message || 'Error', type: 'error', duration: 5e3 }),
              (403 !== a.code && 401 !== a.code && 405 !== a.code) ||
                n['MessageBox']
                  .confirm(
              ...
              Promise.reject(new Error(a.error || 'Error')))
            : a;
        },
        r,
        function (t) {
          return (
            console.log('err' + t),
            Object(n['Message'])({ message: t.message, type: 'error', duration: 5e3 }),
            Promise.reject(t)
          );
        }
      ),
    ...
    c24f: function (t, a, e) {
      ...
      function n(t) {
        return Object(c['a'])({ url: '/users/login', method: 'post', data: t });
      }
      function o(t) {
        return Object(c['a'])({ url: '/users/getme', method: 'get' });
      }
      function l() {
        return Object(c['a'])({ url: '/users/logout', method: 'post' });
      }
      function s(t) {
        return Object(c['a'])({ url: i.findall, method: 'get', params: t });
      }
      ...
      function u(t) {
        return Object(c['a'])({ url: i.agtCreate, method: 'post', params: t });
      }
      function h(t) {
        return Object(c['a'])({ url: ''.concat(i.delete, '/').concat(t.uuid), method: 'delete' });
      }
