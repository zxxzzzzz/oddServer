...
export const loginByAccount = toAsyncTimeFunction(async function (username, password, url) {
    ...
    const res2 = await cuFetch(`${url}/transform.php?ver=${ver}`, {
        headers: {
            ...
            'sec-fetch-mode': 'cors',
            'sec-fetch-site': 'same-origin',
            cookie: 'CookieChk=WQ==; protocolstr=aHR0cHM=; cuipv6=WQ==; cu=WQ==; ipv6=WQ==; test=aW5pdA; login_35838222=MTcyODMwMDk5NQ',
    ...
    const mixObj = Convert.xml2js(text2, { compact: true });
    ...
    const mixObj3 = Convert.xml2js(text3, { compact: true });
